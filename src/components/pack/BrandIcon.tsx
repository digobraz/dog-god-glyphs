...
const FILTERS: Record<Tint, string> = {
  ...
  violet: 'brightness(0) saturate(100%) invert(28%) sepia(85%) saturate(1900%) hue-rotate(205deg) brightness(85%) contrast(92%)', // ≈ Egyptian blue #2E5FD0 (T.partHek, bývalá fialová 2026-06-15)
};
