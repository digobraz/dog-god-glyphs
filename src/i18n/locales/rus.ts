...
export const rus: Partial<Dict> = {
  ...
  'wall.hektor.msg': 'Ты полностью изменил мою жизнь, дружище. Из благодарности собачьему роду я теперь хочу дать миллиону собак второй шанс найти дом и дарить любовь так, как это делал ты. Спасибо за нашу лучшую совместную жизнь. Я люблю тебя.',
