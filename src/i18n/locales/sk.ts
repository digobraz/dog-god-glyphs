...
export const sk: Partial<Dict> = {
  ...
  "pack.invite.statLevel1": "Prvý kruh",
  "pack.invite.statLevel1Sub": "priamo",
  "pack.invite.statLevel2": "Druhý kruh",
  ...
  'pack.network.lineSplit': "{l1} v prvom kruhu · {l2} v druhom",
  'pack.network.circle1': "Prvý kruh — tvoje priame pozvania",
  'pack.network.circle2': "Druhý kruh — pozvania tvojho prvého kruhu",
