...
export const rus: Partial<Dict> = {
  ...
  "transparency.part.affiliate.note": "Не реклама — люди. Это идёт прямиком на счета Dogyptian, которые несут веру дальше, и платится костями: потрать их позже внутри DOGYPT или пожертвуй собакам в беде. Мы вкладываемся в стаю, а не в дорогой маркетинг — стая разносит весть куда лучше.",
