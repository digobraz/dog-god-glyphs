...
export const en = {
  ...
  'pack.trails.title': "Trails",
  'pack.trails.subtitle': "Where dog lovers walk",
  'pack.trails.addTip': "Add a tip",
  'pack.trails.close': "Close",
  'pack.trails.difficultyLabel': "Difficulty",
  'pack.trails.distanceLabel': "Distance",
  'pack.trails.ascentLabel': "Ascent",
  'pack.trails.difficulty.easy': "Easy",
  'pack.trails.difficulty.moderate': "Moderate",
  'pack.trails.difficulty.hard': "Hard",
  'pack.trails.difficulty.extreme': "Extreme",
  'pack.trails.activity.water': "Water",
  'pack.trails.activity.meadow': "Meadow",
  'pack.trails.activity.forest': "Forest",
  'pack.trails.activity.ladders': "Ladders",
  'pack.trails.activity.ford': "Ford",
  'pack.trails.placeType.water': "Water",
  'pack.trails.placeType.cafe': "Dog-friendly cafe",
  'pack.trails.placeType.vet': "Vet",
  'pack.trails.placeType.park': "Park",
  'pack.trails.placeType.shelter': "Shelter",
  'pack.trails.ratingsCount': "{avg} · {count} ratings",
  'pack.trails.noRatingsYet': "No ratings yet",
  'pack.trails.rateThisTrail': "Rate this trail",
  'pack.trails.commentPlaceholder': "A word about this trail…",
  'pack.trails.saving': "Saving…",
  'pack.trails.submitRating': "Submit rating",
  'pack.trails.ratingSaved': "Rating saved — thank you.",
  'pack.trails.ratingError': "Could not save your rating. Try again.",
  'pack.trails.addError': "Could not submit. Try again.",
  'pack.trails.addedPendingToast': "Sent — it's waiting for approval.",
  'pack.trails.filters.allRegions': "All regions",
  'pack.trails.filters.allDifficulties': "All difficulties",
  'pack.trails.addFlow.title': "Add a tip",
  'pack.trails.addFlow.modeTrail': "Trail",
  'pack.trails.addFlow.modePlace': "Place",
  'pack.trails.addFlow.helpTrail': "Tap the map to lay down points along the trail — at least two.",
  'pack.trails.addFlow.helpPlace': "Tap the map once to drop a pin for this place.",
  'pack.trails.addFlow.pointsCount': "{count} points",
  'pack.trails.addFlow.pointPlaced': "Point placed",
  'pack.trails.addFlow.pointNotPlaced': "No point yet — tap the map",
  'pack.trails.addFlow.undo': "Undo last",
  'pack.trails.addFlow.clear': "Clear",
  'pack.trails.addFlow.name': "Name",
  'pack.trails.addFlow.description': "Description",
  'pack.trails.addFlow.region': "Region",
  'pack.trails.addFlow.activities': "Activities",
  'pack.trails.addFlow.placeType': "Place type",
  'pack.trails.addFlow.submit': "Send for approval",
  'pack.trails.moderate.title': "Trails — Moderation",
  'pack.trails.moderate.trailsHeading': "Pending trails",
  'pack.trails.moderate.placesHeading': "Pending places",
  'pack.trails.moderate.empty': "Nothing pending.",
  'pack.trails.moderate.approve': "Approve",
  'pack.trails.moderate.reject': "Reject",
  'pack.trails.moderate.error': "Could not update status. Try again.",
