...
export const rus: Partial<Dict> = {
  ...
  "pack.dog.prayersTotal": "{points} Devotion сегодня",
  ...
  "pack.dog.foodProtocolDesc": "Бренд, порции и аллергии — рацион, которому может доверять весь Pack.",
  "pack.dog.visionHealthTitle": "Протокол здоровья от ИИ + сеть ветеринаров, которым вы доверяете",
  "pack.dog.visionHealthBody": "План долголетия для вашей собаки на базе ИИ — и сеть First-Aid из ветеринаров по всей стране. В этом весь смысл миллиона Dogyptians.",
  ...
  "pack.dog.soon": "Скоро",
  "pack.dog.visionTrainingTitle": "Награды питают вашу Devotion",
  "pack.dog.visionTrainingBody": "Испытания и достижения становятся священными наградами в вашем профиле — и Devotion в Pack. Канон пишется прямо сейчас.",
  ...
  "pack.dog.storyEarnsDevotion": "Каждая история приносит Devotion.",
  ...
  "pack.notif.newMemberToday": "{count} новый Dogyptian сегодня",
  "pack.notif.newMembersToday": "{count} новых Dogyptians сегодня",
  ...
  "pack.notif.totalWorldwide": "{count} Dogyptians по всему миру",
  ...
  "pack.invite.heading": "Растите Pack.",
  "pack.invite.bodyPart1": "Каждый Dogyptian, которого вы приводите, приносит вам",
  "pack.invite.bodyPart2": " — как и каждый, кого приводят они после. Лапа к лапе мы дойдём до миллиона.",
  ...
  "pack.invite.shareNativeText": "Присоединяйся к Pack. Стань Dogyptian.",
  "pack.invite.toastLinkCopied": "Ссылка скопирована",
  "pack.invite.toastLinkCopiedDesc": "Поделитесь ею и растите Pack.",
  ...
  // pack.steps
  "pack.steps.forgeHeroglyph": "Выкуйте свой первый heroglyph",
  "pack.steps.addPhoto": "Добавьте своё фото",
  "pack.steps.addExtraPhotos": "Добавьте больше фото вашей собаки",
  "pack.steps.castVote": "Отдайте свой голос в Shape",
  "pack.steps.flipConstitution": "Пролистайте Constitution",
  ...
  "pack.layout.jumpToStatsAriaLabel": "Перейти к статистике Nation",
  ...
  "pack.survey.featureMobileAppBlurb": "Соцсеть, карта дружелюбных к собакам мест и общение Pack — стая в вашем кармане.",
