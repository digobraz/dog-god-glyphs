...
export const esp: Partial<Dict> = {
  ...
  'vision.finale.cta': 'Conviértete en Dogipcio',
  ...
  'heroglyph.intro.pill.vow.tooltip': 'Tu señal de lealtad al camino dogipcio — ¡Creemos en el perro!',
  ...
  'intro.counter.label': 'perros',
  'intro.question': '¿Tu perro sigue a tu lado?',
  'intro.alive': 'Sí, una leyenda viva',
  'intro.deceased': 'Me espera, allá arriba',
  'intro.continue': 'Empezar',
  'intro.deceasedDate.title': '¿Cuándo cruzó el puente del arcoíris?',
  'intro.deceasedDate.caption': 'Fecha de partida: {date}',
  ...
  'heroglyph.flow.name.dogCountry': 'Hogar',
  ...
  'heroglyph.flow.breed.q1.subtitle': 'Con una suposición basta — no hace falta estar seguro. Elegirás tu patrón a continuación.',
  ...
  'heroglyph.flow.breed.mix.placeholder2': 'Segunda raza (opcional)',
  'heroglyph.flow.breed.mix.dontKnow': 'No estoy seguro — no pasa nada',
  ...
  'heroglyph.checkout.street': 'Calle y Número',
  'heroglyph.checkout.city': 'Ciudad',
  ...
  'heroglyph.checkout.fillAllFields': 'Completa todos los campos para continuar.',
  ...
  'welcome.godWord': 'DIOS',
  'welcome.godPun': '(GOD)',
  // mission text (code source of truth — renders identically)
  'welcome.missionLine1': 'La jauría creció en un dios. Ahora trae al siguiente.',
  ...
  'login.magicLink.needEmail': "Primero escribe tu correo — ¿adónde te envío la llave?",
  ...
  'login.success.body': 'Redirigiéndote a tu jauría…',
  // status: expired
  ...
  'about.crawl.p6': 'Creemos en el perro.',
  ...
  'about.outro.cta': 'Conviértete en Dogipcio',
  ...
  'religion.cta': 'Conviértete en Dogipcio',
  ...
  'religion.preamble.oath': 'El Juramento de la Jauría',
  ...
  'religion.book.sealAlt': 'El sello dogipcio',
  // titleThe / titleBrand / titleConstitution / trust = brand → EN fallback (omitted)
  'religion.book.sub': 'Lectura obligatoria para que todo amante de los perros se convierta en dogipcio.',
  ...
  'religion.book.cta1.btn': 'Conviértete en Dogipcio',
  ...
  'religion.book.coverAlt': 'La Constitución dogipcia',
  ...
  'wall.hero.taglineGod': 'EL PERRO ES DIOS.',
  'wall.hero.cta': 'Conviértete en Dogipcio',
  'wall.hero.total': '1 000 000',
  'wall.hero.dogs': 'PERROS',
  // Hekthor founder card
  'wall.hektor.msg': 'Hekthor, eres mi mayor héroe, mi mejor amigo, mi compañero fiel, mi mentor implacable — eres la historia más hermosa de mi vida. Por ti fundé una religión canina y descubrí que mi amor no tiene nada de especial — todo aquel que alguna vez ha amado a un perro siente exactamente lo mismo en su corazón. Gracias por nuestra mejor vida juntos. Te quiero.',
  // info overlay
  'wall.info.title': '1 000 000 de perros.<br/>¿Lo lograremos?',
  'wall.info.body': 'DOGYPT es un movimiento para amantes de los perros. Cada perro recibe un Heroglyph único — su lugar permanente en la jauría global. Estamos reuniendo un millón de héroes. Sé de los primeros.',
  // filter / numpad
  ...
  'wall.dogPage': 'PÁGINA DEL PERRO',
  'dogPage.livingLegend': 'Leyenda viva',
  'dogPage.dogAngel': 'Ángel perruno',
  'dogPage.livedBestLife': 'Viví mi mejor vida',
  'dogPage.foundingDogyptian': 'Dogipcio Fundador',
  'dogPage.pawtner': 'Pawtner',
  'dogPage.joinUs': 'Únete a Nosotros',
  'dogPage.backToWall': 'Volver al WALL →',
  'dogPage.daysCount': '{days} días',
  'dogPage.notFoundTitle': 'Este perro aún no está en la jauría.',
  'dogPage.notFoundBody': 'Cada perro recibe un Heroglyph — un símbolo único entre los primeros 1 000 000. El tuyo te espera.',
  'share.dogVoice': 'Yo, {dog}, me he unido al movimiento que cambiará el mundo de los perros. ¡Súbete!',

  // ── WHAT NEXT? popup ──
  'whatNext.stamp': 'Importante',
  'whatNext.title': '¿Qué Sigue?',
  ...
  'whatNext.s2.title': 'Ahora Eres un Dogyptian',
  'whatNext.s2.hook': 'No eres un amante de los perros — eres un creyente con correa.',
  'whatNext.s2.body': 'Inscrito en el WALL, para siempre. Cada uno aporta un poco — y <b>juntos, le damos a los perros lo suficiente.</b>',
  'whatNext.s3.title': 'Sé Parte del Cambio',
  'whatNext.s3.hook': 'Una sola pata deja una huella. Un millón traza un camino.',
  'whatNext.s3.body': 'Ayúdanos a llegar al millón de heroglyphs — invita a tus amigos a unirse. <b>Más heroglyphs = más bien para cada perro.</b>',
  ...
  'payment.error': 'No se pudo iniciar el pago. Comprueba tu conexión e inténtalo de nuevo.',
  'payment.photoNotReady': 'La foto de tu perro no terminó de subir. Vuelve al paso de la foto y añádela de nuevo.',
  'payment.back': 'Atrás',
  ...
  'payment.promo.invalid': 'Este código no es válido.',
  'payment.promo.note':
  ...
  'consent.body':
    'Las únicas cookies que recomendamos no son para comer: nos ayudan a mejorar la web. Gracias.',
  ...
  'about.council.role.creator.desc': 'Vídeo, foto, arte para la jauría',
  ...
  // ── Share card ──
  "sharecard.shareTitle": "Comparte {name} con el Pack",
  "sharecard.shareButton": "Compartir",
  "sharecard.download": "Descargar",
  "sharecard.shareText": "{name} es uno de los primeros 1.000.000 de perros de DOGYPT. Encuentra el tuyo en dogypt.com",
  "sharecard.saved": "Tarjeta guardada",
  "sharecard.failed": "No se pudo guardar la tarjeta",
  "sharecard.preparing": "Preparando tu tarjeta…",
  "sharecard.facebook": "Facebook",
  "sharecard.whatsapp": "WhatsApp",
  "sharecard.copyLink": "Copiar enlace",
  "sharecard.linkCopied": "Enlace copiado",
  ...
  "login.forgot.submit": "Envíame una llave nueva",
  ...
  "payment.transparency.hint": "Toca una categoría para ver los detalles.",
  "payment.transparency.eyebrow": "¿Adónde va el dinero?",
  "transparency.part.development": "Desarrollo",
  "transparency.part.affiliate": "Comunidad",
  "transparency.part.directHelp": "Rescate",
  ...
  "transparency.part.affiliate.note": "No son anuncios — son personas. Esto va directo a las cuentas de los dogipcios que difunden la fe, pagado en BONES: gástalos luego dentro de DOGYPT o dónalos a perros necesitados. Invertimos en la jauría, nunca en marketing caro — la jauría lleva la palabra mucho más lejos.",
  "transparency.part.directHelp.note": "Directo a los perros necesitados — refugios, comida, facturas del veterinario y misiones de rescate. Sin intermediarios, sin gastos extra: esta parte va donde está el sufrimiento, y cada céntimo queda documentado, con recibo y hecho público para toda la jauría.",
  "transparency.part.hekthorBowl.note": "El perro fundador que lo empezó todo. Esta parte es una recompensa transparente para Hekthor y su dueño — simplemente su sueldo. Su meta es hacerse millonario — un millón de perros en la manada. Sin Hekthor, DOGYPT nunca habría existido — este cuenco es un agradecimiento.",
  "legal.eyebrow": "DOGYPT · Legal",
  "legal.motto": "DOGYPT · En Perro Confiamos",
  "about.council.formTitle": "Únete a la Misión",
  "about.council.consent": "Al enviar, acepto recibir correos de DOGYPT — sin anuncios, solo movilización de la jauría y comunicación.",
  ...
  "pack.dog.noPhoto": "SIN FOTO",
  "pack.dog.defaultCountry": "Eslovaquia",
  "pack.dog.livingBestLife": "Viviendo mi mejor vida",
  // FIX9 Memorial — deceased dog
  "pack.dog.livedBestLife": "Vivió {poss} mejor vida",
  "pack.dog.inAngelForm": "En forma de ángel",
  "pack.dog.angelSince": "Desde {date}",
  "pack.dog.angelFormTooltip": "En forma de ángel",
  "pack.dog.ariaInAngelForm": "En forma de ángel",
  "pack.dog.inLovingMemory": "En amorosa memoria",
  "pack.dog.memorial.markLink": "Marcar como ángel",
  "pack.dog.memorial.addDate": "Añade el día en que {name} se fue",
  "pack.dog.memorial.editDate": "Editar el día de la partida",
  "pack.dog.memorial.datePrompt": "¿Cuándo se convirtió {name} en ángel?",
  "pack.dog.memorial.confirmTitle": "¿Estás seguro?",
  "pack.dog.memorial.confirmBody": "Esto marca a {name} como fallecido. El contador de días aquí se detiene y comienza su tiempo en forma de ángel.",
  "pack.dog.memorial.confirmYes": "Sí",
  "pack.dog.memorial.cancel": "Cancelar",
  "pack.dog.memorial.save": "Guardar",
  "pack.dog.birthdayUnknown": "Cumpleaños desconocido.",
  "pack.dog.profileDocuments": "Perfil y documentos",
  "pack.dog.ariaBackToProfile": "Volver al perfil",
  ...
  "pack.dog.generating": "Generando…",
  "pack.dog.regeneratePdfs": "Regenerar PDFs",
  "pack.dog.generatePdfs": "Generar PDFs",
  "pack.dog.wordOnWall": "Unas palabras en el WALL",
  "pack.dog.wallPlaceholder": "Unas palabras que aparecen en tu tarjeta del WALL — un homenaje, un recuerdo, un saludo a la jauría.",
  "pack.dog.wallPlaceholderMemorial": "Unas palabras en {poss} memoria — se mostrarán en {poss} tarjeta del WALL.",
  "pack.dog.saving": "Guardando",
  "pack.dog.save": "Guardar",
  "pack.dog.prayersTitle": "Qué momento tan maravilloso para estar vivo.",
  "pack.dog.prayersSubtitle": "Las oraciones de hoy — pequeños actos de Devotion hacia {dogName}.",
  "pack.dog.prayerPresenceTitle": "Oración de Presencia",
  "pack.dog.prayerPresenceHint": "10 minutos de atención plena — jugar, entrenar, simplemente estar. Sin móvil. Esta es la Oración de Presencia.",
  "pack.dog.prayerWalkTitle": "Paseo",
  "pack.dog.prayerWalkHint": "Desliza cuánto tiempo paseaste. Menos de una hora gana 0,5 — luego 1 punto por hora, hasta 5 por una jornada de todo el día.",
  "pack.dog.prayerOpenRitualTitle": "Ritual Abierto",
  "pack.dog.prayerOpenRitualHint": "Añade tus propios actos de Devotion — elige entre más rituales o crea uno personalizado.",
  "pack.dog.comingSoon": "Próximamente",
  "pack.dog.prayerOpenRitualComingSoon": "Más rituales — y los tuyos propios — están en camino.",
  "pack.dog.prayerChoose": "Elegir",
  "pack.dog.prayersLogged": "Registrado para hoy ✓ +{points} ☥",
  "pack.dog.prayersTotal": "{points} Devotion hoy",
  "pack.dog.submit": "Enviar",
  "pack.dog.prayersLockedDesc": "Bloqueado por hoy · se reinicia mañana",
  "pack.dog.prayersAddsStats": "Se suma a tus estadísticas",
  "pack.dog.confirmPrayersTitle": "¿Registrar las oraciones de hoy?",
  "pack.dog.confirmPrayersBody": "Esto es definitivo — la Devotion de hoy no se puede cambiar.",
  "pack.dog.cancel": "Cancelar",
  "pack.dog.logPrayers": "Registrar oraciones",
  "pack.dog.tileHealth": "Salud",
  "pack.dog.tileHealthSub": "Vacunas · Veterinario · Comida",
  "pack.dog.tileTraining": "Adiestramiento",
  "pack.dog.tileTrainingSub": "Comandos · Insignias",
  "pack.dog.tileJournal": "Diario",
  "pack.dog.tileJournalSub": "Historias · Fotos",
  "pack.dog.healthTagline": "Todo el historial de salud en un solo lugar — nada perdido, nada que falte.",
  "pack.dog.healthOverview": "Resumen",
  "pack.dog.shareWithVet": "Compartir con el veterinario",
  "pack.dog.shareVetDesc": "Comparte un perfil de salud de solo lectura con tu veterinario.",
  "pack.dog.factBreed": "Raza",
  "pack.dog.factBorn": "Nacido",
  "pack.dog.factWeight": "Peso",
  "pack.dog.ariaSaveWeight": "Guardar peso",
  "pack.dog.addWeight": "— Añadir peso",
  "pack.dog.factDiet": "Dieta",
  "pack.dog.addDiet": "Añadir dieta…",
  "pack.dog.protection": "Protección",
  "pack.dog.preview": "Vista previa",
  "pack.dog.allergies": "Alergias",
  "pack.dog.conditions": "Afecciones",
  "pack.dog.medication": "Medicación",
  "pack.dog.testPersonality": "Personalidad",
  "pack.dog.testCta": "Hacer test",
  "pack.dog.testPersonalitySub": "Elementos de la MTC — fuego, metal, madera…",
  "pack.dog.testPersonalityComingSoon": "Test de personalidad — próximamente",
  "pack.dog.testPersonalityDesc": "Un breve cuestionario ubica a tu perro entre los cinco elementos.",
  "pack.dog.testIdentity": "Identidad",
  "pack.dog.testIdentitySub": "Descubre {poss} tipo de carácter",
  "pack.dog.testIdentityComingSoon": "Test de identidad — próximamente",
  "pack.dog.testIdentityDesc": "Responde unas pocas preguntas para situar {poss} tipo de carácter.",
  "pack.dog.vetCentre": "Centro veterinario",
  "pack.dog.vetCentreDesc": "Vacunaciones y visitas — pasadas y planificadas — en una sola línea de tiempo que puedes compartir con cualquier veterinario.",
  "pack.dog.foodProtocol": "Protocolo de alimentación",
  "pack.dog.foodProtocolDesc": "Marca, raciones y alergias — la dieta en la que toda la jauría puede confiar.",
  "pack.dog.visionHealthTitle": "Protocolo de Salud por IA + una red de veterinarios de confianza",
  "pack.dog.visionHealthBody": "Un plan de longevidad para tu perro, impulsado por IA — y una red de Primeros Auxilios de veterinarios por todo el país. El verdadero sentido de un millón de dogipcios.",
  "pack.dog.trainingTagline": "Cada comando aprendido, cada prueba ganada — anotado.",
  "pack.dog.trainingCommands": "Comandos",
  "pack.dog.trainingCommandsDesc": "Sentado, quieto, llamada, junto… márcalos a medida que {subj} domina cada uno.",
  "pack.dog.trainingSacredBadges": "Insignias sagradas",
  "pack.dog.trainingSacredBadgesDesc": "Exposiciones, carreras, pruebas de obediencia, países visitados — ganadas, nunca compradas.",
  "pack.dog.trainingObedience": "Obediencia",
  "pack.dog.trainingAgility": "Agility",
  "pack.dog.soon": "Pronto",
  "pack.dog.visionTrainingTitle": "Las insignias alimentan tu Devotion",
  "pack.dog.visionTrainingBody": "Las pruebas y los hitos se convierten en insignias sagradas en tu perfil — y en Devotion dentro de la jauría. El canon se está escribiendo.",
  "pack.dog.journalTagline": "Toda {poss} vida, conservada.",
  "pack.dog.instantStory": "Historia Instantánea",
  "pack.dog.instantStoryDesc": "Solo cuenta el momento — una rápida nota de voz que se registra bajo la fecha de hoy y se convierte en texto, quizá algún día una página de {poss} libro. Añade unas fotos y el día queda guardado para siempre.",
  "pack.dog.instantStoryComingSoon": "Historia Instantánea — próximamente",
  "pack.dog.instantStoryToastDesc": "Graba una nota de voz y se registra bajo la fecha de hoy.",
  "pack.dog.recordStory": "Grabar una historia",
  "pack.dog.attachPhotosDesc": "Adjunta fotos al momento.",
  "pack.dog.addPhotos": "Añadir fotos",
  "pack.dog.storyEarnsDevotion": "Cada historia gana Devotion.",
  "pack.dog.storyArchive": "Archivo de historias",
  "pack.dog.storyArchiveEmpty": "{poss} historias vivirán aquí — las más recientes primero, cada nota de voz y foto por fecha.",
  "pack.dog.photoAlbum": "Álbum de fotos",
  "pack.dog.addPhoto": "Añadir foto",
  "pack.dog.noPhotosYet": "Aún no hay fotos.",
  "pack.dog.statsDesc": "Cada día que registras brilla — un calendario vivo de tu Devotion.",
  "pack.dog.toastCouldntLog": "No se pudo registrar — inténtalo de nuevo",
  "pack.dog.toastSaved": "Guardado",
  "pack.dog.toastCouldNotSave": "No se pudo guardar",
  "pack.dog.toastUnknownError": "Error desconocido",
  "pack.dog.toastMessageSaved": "Mensaje guardado",
  "pack.dog.toastMessageSavedDesc": "Visible en tu tarjeta del WALL.",
  "pack.dog.toastPhotoAdded": "Foto añadida",
  "pack.dog.toastUploadFailed": "Error al subir",
  "pack.dog.toastCouldNotRemove": "No se pudo eliminar",
  "pack.dog.toastPhotoUpdated": "Foto actualizada",
  "pack.dog.toastPhotoUpdatedDesc": "El WALL y el certificado se actualizan — próximamente.",
  "pack.dog.toastCertReady": "Certificado listo",
  "pack.dog.toastCertReadyDesc": "Tus PDFs se han generado.",
  "pack.dog.toastCouldNotGenerate": "No se pudieron generar los PDFs",
  "pack.dog.toastCouldNotResend": "No se pudo reenviar",
  "pack.dog.toastEmailResent": "Correo reenviado",
  "pack.dog.toastEmailResentDesc": "Revisa tu bandeja de entrada en un momento.",
  "pack.dog.resendEmail": "Reenviar correo",
  "pack.dog.healthHealthy": "Sano",
  "pack.dog.healthInjury": "Lesión",
  "pack.dog.healthGastro": "Gastro",
  "pack.dog.healthAllergy": "Alergia",
  "pack.dog.healthOther": "Otro",
  "pack.dog.healthVision": "Algún día, marcar a tu perro como enfermo alertará a los sanadores DOGYPT cercanos a ti — y nuestra IA se pondrá en contacto para ayudar. Una red mundial de primeros auxilios para perros.",
  "pack.dog.visionNotLive": "Visión · aún no activa",
  "pack.dog.shieldParasites": "Parásitos",
  "pack.dog.shieldParasitesNote": "Próxima dosis antiparasitaria y recordatorios.",
  "pack.dog.shieldVaccination": "Vacunación",
  "pack.dog.shieldVaccinationNote": "Ventana de refuerzo y el historial completo de vacunación.",
  "pack.dog.shieldImmunity": "Inmunidad",
  "pack.dog.shieldImmunityNote": "Preparación inmunitaria general.",
  "pack.dog.shieldJoints": "Cuidado articular",
  "pack.dog.shieldJointsNote": "Suplementos de soporte articular y su pauta.",
  ...
  "pack.dog.legendStroll": "Vuelta",
  "pack.dog.legendStrollDesc": "Una vuelta rápida a la manzana",
  "pack.dog.legendVet": "Veterinario",
  "pack.dog.legendVetDesc": "Salud y revisiones",
  "pack.dog.legendBirthday": "Cumpleaños",
  "pack.dog.legendBirthdayDesc": "El de verdad",
  "pack.dog.legendHumanYear": "Año humano",
  "pack.dog.legendHumanYearDesc": "1 de 7 — planea algo",
  "pack.dog.legend": "Leyenda",
  "pack.dog.addActivity": "Añadir actividad",
  "pack.dog.addActivityDesc": "Nombre, color e icono — próximamente",
  "pack.dog.ariaShowAgeDetail": "Mostrar detalle de la edad",
  "pack.dog.ageDetail": "{years}a {months}m {days}d · ≈ {humanYears} años humanos",
  "pack.dog.ariaStillAlive": "Aún vivo",
  "pack.dog.stillAliveTooltip": "Aún vivo, listo para divertirse",
  "pack.dog.dailyPrayers": "Oraciones Diarias",
  "pack.dog.prayersComingSoonDesc": "Los actos diarios de Devotion hacia {dogName} — la presencia, el paseo y el ritual — están en camino.",
  "pack.dog.statusLive": "En vivo",
  "pack.dog.mainBadge": "PRINCIPAL",
  "pack.dog.ariaRemovePhoto": "Eliminar foto",
  "pack.dog.certOfficialRecord": "El registro oficial",
  "pack.dog.notFound": "No encontrado",
  "pack.dog.notFoundDesc": "Este heroglyph no es tuyo o ya no existe.",
  "pack.dog.backToPack": "Volver a la jauría",
  "pack.dog.errorLoading": "Algo salió mal al cargar este heroglyph.",
  "pack.dog.monthJan": "Ene",
  ...
  // pack.globe
  "pack.globe.ariaGlobe": "La jauría en todo el mundo",
  "pack.globe.roadToMillion": "El camino hacia el millón",
  "pack.globe.ariaMilestone": "Hito {n}",
  "pack.globe.ariaPrev": "Hito anterior",
  "pack.globe.ariaNext": "Hito siguiente",
  "pack.globe.achieved": "LOGRADO",
  "pack.globe.counterDogyptians": "Dogipcios",
  "pack.globe.counterWorldwide": "en todo el mundo",
  "pack.globe.topCountries": "Top países",
  "pack.globe.topBreeds": "Top razas",
  "pack.globe.communityTitle": "Comunidad",
  "pack.globe.milestoneFounders": "Los Fundadores",
  "pack.globe.milestonePack": "La Jauría",
  "pack.globe.milestoneNation": "La Nación",
  "pack.globe.milestoneDynasty": "La Dinastía",
  // pack.devotion (panel heading)
  "pack.devotion.heading": "Devotion",
  // pack.ladder — 22-tier devotion rank ladder
  "pack.ladder.novice": "Novicio",
  "pack.ladder.wanderer": "Errante",
  "pack.ladder.follower": "Seguidor",
  "pack.ladder.believer": "Creyente",
  "pack.ladder.servant": "Siervo",
  "pack.ladder.aspirant": "Aspirante",
  "pack.ladder.mentor": "Mentor",
  "pack.ladder.steward": "Mayordomo",
  "pack.ladder.shepherd": "Pastor",
  "pack.ladder.sentinel": "Centinela",
  "pack.ladder.elder": "Anciano",
  "pack.ladder.sage": "Sabio",
  "pack.ladder.cleric": "Clérigo",
  "pack.ladder.mystic": "Místico",
  "pack.ladder.priest": "Sacerdote",
  "pack.ladder.paladin": "Paladín",
  ...
  "pack.ladder.demigod": "Semidiós",
  // pack.rank
  "pack.rank.viewAll": "Ver todo →",
  "pack.rank.ariaClose": "Cerrar",
  "pack.rank.noData": "Aún no hay datos — el tablero se llena a medida que la jauría crece.",
  // pack.hero
  "pack.hero.ariaEditAvatar": "Editar avatar",
  "pack.hero.ariaEditName": "Editar nombre",
  "pack.hero.ariaSaveName": "Guardar nombre",
  "pack.hero.ariaDevotionBar": "Devotion {points}, nivel {index} {name}",
  "pack.hero.welcomeBack": "Bienvenido de nuevo",
  "pack.hero.namePlaceholder": "Tu nombre",
  "pack.hero.toastPhotoUpdated": "Foto actualizada",
  "pack.hero.toastUploadFailed": "Error al subir",
  "pack.hero.toastNameUpdated": "Nombre actualizado",
  "pack.hero.toastCouldNotSave": "No se pudo guardar",
  "pack.hero.devotionToNext": "{toNext} ☥ para {nextName}",
  "pack.hero.devotionMaxReached": "Máxima devotion alcanzada",
  // pack.notif
  "pack.notif.ariaMessages": "Mensajes — próximamente",
  "pack.notif.ariaNotifications": "Notificaciones",
  "pack.notif.soon": "pronto",
  "pack.notif.dropdownTitle": "El pulso de la jauría",
  "pack.notif.newMemberToday": "{count} nuevo dogipcio hoy",
  "pack.notif.newMembersToday": "{count} nuevos dogipcios hoy",
  "pack.notif.noNewMembersToday": "Aún ningún miembro nuevo hoy",
  "pack.notif.joinedLast30d": "{count} se unieron en los últimos 30 días",
  "pack.notif.totalWorldwide": "{count} dogipcios en todo el mundo",
  "pack.notif.personalComingSoon": "Notificaciones personales próximamente",
  // pack.invite
  "pack.invite.close": "Cerrar",
  "pack.invite.ariaHowLineWorks": "Cómo funciona tu línea",
  "pack.invite.ariaWhereMoneyGoes": "A dónde va cada euro",
  "pack.invite.hekthorAlt": "Hekthor — fundador #1",
  "pack.invite.heading": "Haz crecer la jauría.",
  "pack.invite.bodyPart1": "Cada dogipcio que traigas te hace ganar",
  "pack.invite.bodyPart2": " — y también todos los que ellos traigan después. Pata a pata, llegamos al millón.",
  "pack.invite.statLevel1": "Primera pata",
  "pack.network.circle2": "Segunda pata — las invitaciones de tu primera pata",
  "pack.network.circle1": "Primera pata — tus invitaciones directas",
  "pack.network.lineSplit": "{l1} en la primera pata · {l2} en la segunda",
  "pack.invite.statLevel1Sub": "directos",
  "pack.invite.statLevel2": "Segunda pata",
  "pack.invite.statLevel2Sub": "los que ellos traen",
  "pack.invite.ariaViewNetwork": "Ver tu red — próximamente",
  "pack.invite.viewNetworkSoon": "Ver tu red · pronto",
  "pack.invite.generatingLink": "Generando tu enlace…",
  "pack.invite.ariaCopyLink": "Copiar enlace de invitación",
  "pack.invite.shareLink": "Comparte tu enlace",
  "pack.invite.rewardsNote": "Las recompensas para los mejores apóstoles se desbloquean a medida que la religión crece.",
  "pack.invite.shareNativeText": "Únete a la jauría. Conviértete en dogipcio.",
  "pack.invite.toastLinkCopied": "Enlace copiado",
  "pack.invite.toastLinkCopiedDesc": "Compártelo y haz crecer la jauría.",
  "pack.invite.toastCouldNotCopy": "No se pudo copiar",
  "pack.invite.transparencyTitle": "Transparencia",
  "pack.invite.transparencySubtitle": "¿A dónde va cada {price}?",
  "pack.invite.tapBlockHint": "Toca un bloque para ver a dónde va.",
  "pack.invite.yourLineTitle": "Tu línea",
  "pack.invite.yourLineDesc": "Trae a un amante de los perros — y gana con todos los que ellos traigan después.",
  "pack.invite.lineNodeYou": "Tú",
  "pack.invite.lineNodeFriend": "Amigo",
  "pack.invite.lineNodeTheirFriend": "Su amigo",
  "pack.invite.examplePart1": "Traes",
  "pack.invite.examplePart2": "ganas",
  "pack.invite.examplePart3": "trae",
  "pack.invite.examplePart4": "ganas",
  "pack.invite.examplePart5": "más.",
  "pack.invite.examplePart6": "Tu línea te sigue pagando — pata a pata.",
  "pack.invite.bonesRate": "10 BONES = €1 — gástalos dentro de DOGYPT.",
  "pack.invite.brings": "trae",
  // pack.settings
  "pack.settings.account": "Cuenta",
  "pack.settings.email": "Correo electrónico",
  "pack.settings.password": "Contraseña",
  "pack.settings.setChange": "Establecer / Cambiar",
  "pack.settings.language": "Idioma",
  "pack.settings.notifications": "Notificaciones",
  "pack.settings.comingSoon": "Próximamente",
  "pack.settings.signOut": "Cerrar sesión",
  "pack.settings.close": "Cerrar",
  "pack.settings.pwDescWelcome": "Termina tu cuenta — establece una contraseña para iniciar sesión en cualquier momento sin el enlace del correo.",
  "pack.settings.pwDesc": "Establece o cambia tu contraseña para iniciar sesión con correo + contraseña.",
  "pack.settings.pwNewPlaceholder": "Nueva contraseña (mín. 8 caracteres)",
  "pack.settings.pwConfirmPlaceholder": "Confirmar contraseña",
  "pack.settings.pwSubmit": "Establecer contraseña",
  "pack.settings.errPwShort": "La contraseña debe tener al menos 8 caracteres.",
  "pack.settings.errPwMismatch": "Las contraseñas no coinciden.",
  "pack.settings.errPwGeneric": "No se pudo establecer la contraseña.",
  "pack.settings.toastTitle": "Contraseña establecida",
  "pack.settings.toastDesc": "Ahora puedes iniciar sesión con correo + contraseña.",
  // pack.steps
  "pack.steps.forgeHeroglyph": "Crea tu primer Heroglyph",
  "pack.steps.addPhoto": "Añade tu foto",
  "pack.steps.addExtraPhotos": "Añade fotos extra de tu perro",
  "pack.steps.castVote": "Vota qué sigue",
  "pack.steps.flipConstitution": "Hojea la DOGMA",
  "pack.steps.inviteDogLover": "Invita a tu primer amante de los perros",
  "pack.steps.sectionLabel": "Tu perfil",
  "pack.steps.heading": "Primeros Pasos",
  "pack.steps.rewardAllDone": "Primeros Pasos completados — el próximo capítulo de la app llega pronto.",
  "pack.steps.rewardPending": "Completa todos los Primeros Pasos =",
  "pack.steps.rewardPendingSuffix": "a tu perfil.",
  // pack.tree
  "pack.tree.title": "Mi jauría",
  "pack.tree.emptyState": "Aún no hay heroglyphs",
  "pack.tree.noPhoto": "SIN FOTO",
  "pack.tree.openDogProfileTitle": "Abrir perfil del perro — certificados, PDFs, fotos",
  "pack.tree.openDogProfileAriaLabel": "Abrir perfil del perro",
  "pack.tree.addDog": "Añadir",
  "pack.tree.addHumanMember": "Añadir miembro humano",
  "pack.tree.addHumanMemberTooltip": "Próximamente — invita a un miembro humano",
  "pack.tree.ownerAvatarAlt": "dueño",
  // pack.layout
  "pack.layout.loading": "CARGANDO…",
  "pack.layout.yourAvatarAlt": "Tu avatar",
  "pack.layout.profileAriaLabel": "Perfil",
  "pack.layout.jumpToStatsAriaLabel": "Ir a las estadísticas de la nación",
  "pack.layout.dogFallbackAriaLabel": "Perro",
  "pack.layout.navHome": "Inicio",
  "pack.layout.navMap": "Mapa",
  "pack.layout.navDogs": "Perros",
  // pack.survey
  "pack.survey.heading": "Da forma a la app",
  "pack.survey.subheading": "¿Qué deberíamos construir primero?",
  "pack.survey.toggleVote": "Votar",
  "pack.survey.toggleResults": "Resultados",
  "pack.survey.featureMobileAppTitle": "App Móvil",
  "pack.survey.featureMobileAppBlurb": "Red social, mapa de lugares dog-friendly y mucho más — en tu bolsillo.",
  "pack.survey.featureHealthAiTitle": "Protocolo de Salud por IA",
  "pack.survey.featureHealthAiBlurb": "Un plan de longevidad para tu perro, impulsado por IA — más una red de veterinarios de confianza.",
  "pack.survey.featureMerchTitle": "Merch",
  "pack.survey.featureMerchBlurb": "Impresiones de heroglyph, collares, libros y accesorios sagrados.",
  "pack.survey.voteForThis": "Voto por esto",
  "pack.survey.voted": "Votado",
  "pack.survey.dotAriaLabel": "Ir a {title}",
  "pack.survey.collectingUntil": "Recogiendo votos hasta {date} — y entonces construimos.",
  "pack.survey.totalVotes": "{count} votos",
  "pack.survey.navPrevious": "Anterior",
  "pack.survey.navNext": "Siguiente",
  // pack.verse
  "pack.verse.ariaLabel": "Versículo del día",
  "pack.verse.eyebrow": "Versículo del día",
  "pack.verse.unknownAuthor": "Desconocido",
  // pack.dogma
  "pack.dogma.imgAlt": "DOGMA — la DOGMA dogipcia",
  "pack.dogma.cta": "Lee el DOGMA",
  "pack.dogma.description": "El fundamento de toda la fe — todo dogipcio debería leerlo. La filosofía, la lógica y cómo funciona la devotion empiezan aquí.",
  // pack.build
  "pack.build.badge": "En construcción",
  "pack.build.heading": "Gracias por tu paciencia",
  "pack.build.body": "Todavía lo construye un humano y sus agentes de IA. Cada error o idea ayuda.",
  "pack.build.successMsg": "Recibido — gracias. Leemos cada palabra.",
  "pack.build.placeholder": "Un error o una idea… para errores, añade tu dispositivo y navegador.",
  "pack.build.attachmentPreviewAlt": "vista previa del adjunto",
  "pack.build.removePhotoAriaLabel": "Eliminar foto",
  "pack.build.attachPhoto": "Adjunta una foto como prueba",
  "pack.build.errorMsg": "Algo salió mal. Inténtalo de nuevo.",
  "pack.build.uploading": "Subiendo…",
  "pack.build.sending": "Enviando…",
  "pack.build.sendBtn": "Enviar feedback",
  "pack.build.councilPrompt": "¿Quieres trabajar en ello con nosotros?",
  "pack.build.councilCta": "Únete al Consejo",

  // pack.stats — TransparentStats 2026-06-24
  "pack.stats.title": "Estadísticas transparentes",
  "pack.stats.short.jun26": "jun",
  "pack.stats.short.may26": "may",
  "pack.stats.thisMonth": "este mes",
  "pack.stats.development": "Desarrollo",
  "pack.stats.affiliate": "Comunidad",
  "pack.stats.directHelp": "Rescate",
  "pack.stats.hekthorBowl": "El cuenco de Hekthor",
  "pack.stats.split": "¿Por qué este reparto? Lee «Money is an Energy» en la DOGMA →",
  "pack.stats.bonesDistributed": "BONES repartidos a la jauría",
  "pack.stats.allTime": "Total",
  "pack.stats.created": "creados",
  "pack.stats.raised": "{amount} recaudado",
  ...
  'heroglyph.sales.card.wall.note': 'Tu perro para siempre en el WALL',
  'heroglyph.sales.card.profile.title': 'Perfil',
  'heroglyph.sales.card.profile.note': 'Tu lugar seguro en el mundo digital amigable con los perros',
  'heroglyph.sales.why': '¿Por qué €11?',
  'heroglyph.sales.eyebrow': 'Tu billete hacia DOGYPT',
  'heroglyph.sales.title': 'Heroglyph',
  'heroglyph.sales.subtitle': 'Un símbolo único que os describe a ti y a tu perro — vuestro vínculo eterno.',
  'heroglyph.sales.loading': 'Cargando tu heroglyph…',
  ...
  'entry.subtitle': 'Esto no es una broma. Toda religión seria debe declarar estas cosas.',
  'entry.criteria.theology.title': 'Teología',
  'entry.criteria.theology.body': 'Mejor amigo, guardián, maestro, compañero en cada aventura. El perro da amor sin condiciones — y caminar a su lado nos hace más humanos.',
  'entry.criteria.canon.title': 'Canon',
  'entry.criteria.canon.body': 'Toda fe tiene su escritura. La nuestra es la DOGMA: nuestro vínculo con el perro escrito a lo largo de doce capítulos, de lectura libre en dogma.dogypt.com.',
  'entry.criteria.community.title': 'Comunidad',
  'entry.criteria.community.body': 'Somos amantes de los perros con un propósito. Solos, cada uno puede cambiar poco — juntos, nuestro poder no tiene límite.',
  'entry.criteria.symbol.title': 'Símbolo',
  'entry.criteria.symbol.body': 'Toda fe tiene su señal. La nuestra es el heroglyph: una marca sagrada única para cada perro, comprendida en cualquier idioma, en cualquier lugar.',
  'entry.criteria.ritual.title': 'Ritual',
  'entry.criteria.ritual.body': 'El paseo. Terapia diaria que mantiene en forma el cuerpo y la mente — y también el alma. El ritual más antiguo que ya cumplimos sin que nadie nos lo diga.',
  'entry.criteria.vision.title': 'Visión',
  'entry.criteria.vision.body': 'Elevar el vínculo entre el humano y el perro — y luchar por el respeto y la vida mejor que todo perro merece.',
  'entry.criteria.offerings.title': 'Ofrendas',
  'entry.criteria.offerings.note': '(un tributo simbólico)',
  'entry.criteria.offerings.pill': '€11 · pago único',
  'entry.criteria.offerings.tag': '100% transparencia',
  'entry.criteria.offerings.body': '€11, una sola vez. Una ofrenda simbólica — cada ingreso y cada gasto en un libro abierto a todos. La energía que nos mantiene vivos.',
  'entry.criteria.legitimacy.title': 'Legitimidad',
  'entry.criteria.legitimacy.pill': '{count} miembros restantes',
  'entry.criteria.legitimacy.body': 'Mil fundadores, y seremos lo bastante fuertes para registrarnos como una nación que la ley deba reconocer. El último hito — solo tú puedes alcanzarlo.',
  'entry.criteria.doneLabel': 'hecho',
  'entry.sheet.tapToClose': 'toca para cerrar',
  'entry.signed.prefix': 'Ya firmado por',
  'entry.signed.suffix': 'amantes de los perros',
  'entry.cta': 'Añadir mi nombre',
  "pack.profile.countryFrequent": "Cercanos",
  "pack.profile.countryAll": "Todos los países",
  "pack.profile.countryOther": "Prefiero no decirlo",
  "pack.profile.countryAria": "País",
  "pack.profile.pilgrimCta": "Perfil de senderismo",
};
