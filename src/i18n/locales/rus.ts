...
export const rus: Partial<Dict> = {
  ...
  'consent.title': 'Здесь ничего не скрыто',
  'consent.body':
    'Анонимная аналитика работает всегда — так мы замечаем, что сломалось, и чиним это для каждого друга собак, который заходит. Записи сессий и маркетинг включаются, только если ты согласишься.',
  'consent.acceptAll': 'Разрешить всё',
  'consent.necessary': 'Только необходимое',
  'consent.settings': 'Дай мне выбрать',
  'consent.save': 'Сохранить мой выбор',
  'consent.analytics.label': 'Аналитика и записи',
  'consent.analytics.desc':
    'Включает полную продуктовую аналитику и записи сессий, чтобы мы видели, где друзья собак застревают, и сглаживали путь.',
  'consent.marketing.label': 'Маркетинг',
  'consent.marketing.desc':
    'Позволяет нам использовать рекламные cookies (например, Meta Pixel), чтобы находить новых друзей собак. Пока выключено — включаем это только позже.',
