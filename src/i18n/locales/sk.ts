...
export const sk: Partial<Dict> = {
  ...
  "pack.dog.lostDogTooltip": "Stratený pes — vyhlás pátranie, upozorni Pack. Už čoskoro.",
  ...
  "pack.dog.wallPlaceholder": "Pár slov, ktoré sa ukážu na tvojej karte na WALL — pocta, spomienka, pozdrav celému Packu.",
  ...
  "pack.dog.foodProtocolDesc": "Značka, dávky a alergie — strava, ktorej môže veriť celý Pack.",
  "pack.dog.visionHealthTitle": "Zdravotný protokol od AI + sieť veterinárov, ktorým veríš",
  "pack.dog.visionHealthBody": "Plán dlhovekosti pre tvojho psa poháňaný AI — a sieť prvej pomoci veterinárov po celom národe. Celý zmysel milióna Dogyptians.",
  ...
  "pack.dog.visionTrainingTitle": "Odznaky kŕmia tvoju Devotion",
  "pack.dog.visionTrainingBody": "Skúšky a míľniky sa stávajú posvätnými odznakmi na tvojom profile — a Devotion v Packu. Kánon sa práve píše.",
  ...
  "pack.dog.storyEarnsDevotion": "Každý príbeh prináša Devotion.",
  ...
  // pack.globe
  "pack.globe.ariaGlobe": "Pack po celom svete",
  ...
  "pack.rank.noData": "Zatiaľ žiadne dáta — tabuľka sa zapĺňa, ako rastie Pack.",
  // pack.hero
  ...
  "pack.notif.dropdownTitle": "Pulz Packu",
  ...
  "pack.notif.totalWorldwide": "{count} Dogyptians po celom svete",
  ...
  "pack.invite.heading": "Rozšír Pack.",
  "pack.invite.bodyPart1": "Každý Dogyptian, ktorého privedieš, ti zarobí",
  "pack.invite.bodyPart2": " — a tak isto každý, koho privedú oni po tebe. Labka k labke dosiahneme milión.",
  ...
  "pack.invite.rewardsNote": "Odmeny pre najlepších apoštolov sa odomknú, ako náboženstvo rastie.",
  "pack.invite.shareNativeText": "Pridaj sa k Packu. Staň sa Dogyptian.",
  "pack.invite.toastLinkCopied": "Odkaz skopírovaný",
  "pack.invite.toastLinkCopiedDesc": "Zdieľaj ho a rozšír Pack.",
  ...
  // pack.steps
  "pack.steps.forgeHeroglyph": "Vykov svoj prvý Heroglyph",
  "pack.steps.addPhoto": "Pridaj svoju fotku",
  "pack.steps.addExtraPhotos": "Pridaj ďalšie fotky svojho psa",
  "pack.steps.castVote": "Odovzdaj svoj hlas v Shape",
  "pack.steps.flipConstitution": "Prelistuj Constitution",
  "pack.steps.inviteDogLover": "Pozvi svojho prvého psíčkara",
  ...
  "pack.layout.jumpToStatsAriaLabel": "Preskočiť na štatistiky Nation",
  ...
  "pack.survey.featureMobileAppBlurb": "Sociálna sieť, mapa miest priateľských k psom a správy v Packu — Pack vo tvojom vrecku.",
  ...
  "pack.dogma.description": "Základ celej viery — mal by ju prečítať každý Dogyptian. Filozofia, logika aj to, ako funguje oddanosť, sa všetko začína tu.",
  // pack.build
  ...
  "pack.stats.split": "Prečo toto rozdelenie? Prečítaj si 'Money is an Energy' v Constitution →",
  "pack.stats.bonesDistributed": "BONES rozdelených Packu",
