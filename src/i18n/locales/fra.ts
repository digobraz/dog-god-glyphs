...
export const fra: Partial<Dict> = {
  ...
  'heroglyph.flow.breed.q1.subtitle': "Une supposition suffit — pas besoin d'être sûr. Tu choisiras ton patron juste après.",
  ...
  'heroglyph.flow.breed.mix.placeholder2': 'Deuxième race (facultatif)',
  'heroglyph.flow.breed.mix.dontKnow': 'Pas sûr — pas de souci',
  ...
  'heroglyph.checkout.fillAllFields': 'Veuillez remplir tous les champs pour continuer.',
  ...
  // ── Share card ──
  "sharecard.shareTitle": "Partage {name} avec le Pack",
  "sharecard.shareButton": "Partager",
  "sharecard.download": "Télécharger",
  "sharecard.shareText": "{name} fait partie des 1 000 000 premiers chiens de DOGYPT. Trouve le tien sur dogypt.com",
  "sharecard.saved": "Carte enregistrée",
  "sharecard.failed": "La carte n'a pas pu être enregistrée",
  "sharecard.preparing": "Préparation de ta carte…",
  "sharecard.facebook": "Facebook",
  "sharecard.whatsapp": "WhatsApp",
  "sharecard.copyLink": "Copier le lien",
  "sharecard.linkCopied": "Lien copié",
  ...
  "pack.dog.passportTooltip": "DOG ID de ton chien — une base de données mondiale. Bientôt disponible.",
  ...
  "pack.globe.topCountries": "Top pays",
  "pack.globe.topBreeds": "Top races",
  "pack.globe.communityTitle": "Communauté",
  ...
  "pack.invite.statLevel1": "Première patte",
  "pack.network.circle2": "Deuxième patte — les invitations de votre première patte",
  "pack.network.circle1": "Première patte — vos invitations directes",
  "pack.network.lineSplit": "{l1} dans la première patte · {l2} dans la deuxième",
  "pack.invite.statLevel1Sub": "direct",
  "pack.invite.statLevel2": "Deuxième patte",
  ...
  "pack.stats.created": "créés",
  "pack.stats.raised": "{amount} récolté",
  "pack.dog.statsTitle": "STATS",

  // ── /entry + /heroglyph sales (i18n 2026-07-13) ──
  'heroglyph.sales.pricePill': 'Paiement unique €11 · ton entrée',
  'heroglyph.sales.card.cert.title': 'Certificat',
  'heroglyph.sales.card.cert.note': 'Des PDF au design unique',
  'heroglyph.sales.card.wall.title': 'WALL',
  'heroglyph.sales.card.wall.note': 'Ton chien pour toujours sur le WALL',
  'heroglyph.sales.card.profile.title': 'Profil',
  'heroglyph.sales.card.profile.note': 'Ta place sûre dans le monde numérique des amoureux des chiens',
  'heroglyph.sales.why': 'Pourquoi €11 ?',
  'heroglyph.sales.eyebrow': 'Ton billet pour DOGYPT',
  'heroglyph.sales.title': 'Heroglyph',
  'heroglyph.sales.subtitle': 'Un symbole unique qui te décrit, toi et ton chien — votre lien éternel.',
  'heroglyph.sales.loading': 'Chargement de ton heroglyph…',
  'heroglyph.sales.cta': 'Créer le Heroglyph',
  'heroglyph.sales.back': 'Retour',
  'heroglyph.sales.transparency.title': '100 % de transparence',
  'heroglyph.sales.transparency.tribute': 'Ton entrée — €11, une seule fois',
  'heroglyph.sales.transparency.footer': 'Chaque euro reste à la vue de tous, visible par chaque membre. Tu ne paies pas une entreprise — tu nourris la meute.',
  'entry.declare.eyebrow': 'Par la présente, je déclare',
  'entry.title': 'Au Chien je crois',
  'entry.subtitle': 'Ce n’est pas une plaisanterie. Toute religion sérieuse doit déclarer ces choses.',
  'entry.criteria.theology.title': 'Théologie',
  'entry.criteria.theology.body': 'Meilleur ami, gardien, professeur, partenaire de chaque aventure. Le chien donne son amour sans conditions — et marcher à ses côtés nous rend plus humains.',
  'entry.criteria.canon.title': 'Canon',
  'entry.criteria.canon.body': 'Chaque foi a son écriture. La nôtre est la DOGMA : notre lien avec le chien écrit en douze chapitres, à lire librement sur dogma.dogypt.com.',
  'entry.criteria.community.title': 'Communauté',
  'entry.criteria.community.body': 'Nous sommes des amoureux des chiens avec une mission. Seul, chacun de nous peut changer peu de choses — ensemble, notre puissance n’a aucune limite.',
  'entry.criteria.symbol.title': 'Symbole',
  'entry.criteria.symbol.body': 'Chaque foi a son signe. Le nôtre est le Heroglyph : une marque sacrée unique pour chaque chien, comprise dans toutes les langues, partout.',
  'entry.criteria.ritual.title': 'Rituel',
  'entry.criteria.ritual.body': 'La promenade. Une thérapie quotidienne qui garde le corps et l’esprit en forme — et l’âme aussi. Le plus ancien rituel que nous observons déjà sans qu’on nous le dise.',
  'entry.criteria.vision.title': 'Vision',
  'entry.criteria.vision.body': 'Élever le lien entre l’humain et le chien — et se battre pour le respect et la vie meilleure que chaque chien mérite.',
  'entry.criteria.offerings.title': 'Offrandes',
  'entry.criteria.offerings.note': '(un tribut symbolique)',
  'entry.criteria.offerings.pill': '€11 · une seule fois',
  'entry.criteria.offerings.tag': '100 % de transparence',
  'entry.criteria.offerings.body': '€11, une seule fois. Une offrande symbolique — chaque revenu et chaque dépense sur un registre ouvert à tous. L’énergie qui nous garde en vie.',
  'entry.criteria.legitimacy.title': 'Légitimité',
  'entry.criteria.legitimacy.pill': '{count} membres restants',
  'entry.criteria.legitimacy.body': 'Mille fondateurs, et nous serons assez forts pour nous enregistrer comme une nation que la loi devra reconnaître. Le dernier jalon — toi seul peux l’atteindre.',
  'entry.criteria.doneLabel': 'fait',
  'entry.sheet.tapToClose': 'appuie pour fermer',
  'entry.signed.prefix': 'Déjà signé par',
  'entry.signed.suffix': 'amoureux des chiens',
  'entry.cta': 'Ajouter mon nom',
  "pack.profile.countryFrequent": "À proximité",
  "pack.profile.countryAll": "Tous les pays",
  "pack.profile.countryOther": "Je préfère ne pas dire",
  "pack.profile.countryAria": "Pays",
  "pack.profile.pilgrimCta": "Profil rando",
};
