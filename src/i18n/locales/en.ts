...
export const en = {
  ...
  'pack.mapNotes.kind.hazard': "Hazard",
  'pack.mapNotes.kind.note': "Note",
  ...
  'pack.mapNotes.hint': "Press and hold anywhere on the map to leave a note for the pack.",
  ...
  'pack.mapNotes.add.dragHint': "Drag the marker if it is not exactly right.",
  ...
  'pack.mapNotes.section.title': "On the map",
  'pack.mapNotes.section.add': "Add to map",
  'pack.mapNotes.section.empty': "Nobody has written anything here yet. Be the first.",
  'pack.mapNotes.fab.ready': "Leave a note here",
  'pack.mapNotes.fab.locked': "Zoom in to unlock writing on the map",
