...
export const sk: Partial<Dict> = {
  ...
  "pack.page.steps.forge": "Vytvor svoj prvý Heroglyph",
  "pack.page.steps.photo": "Pridaj svoju fotku",
  "pack.page.steps.extras": "Pridaj ďalšie fotky svojho psa",
  "pack.page.steps.vote": "Zahlasuj v sekcii Tvar",
  "pack.page.steps.constitution": "Prelistuj Ústavu",
  "pack.page.steps.invite": "Pozvi svojho prvého milovníka psov",
  "pack.nav.loading": "NAČÍTAVA SA…",
  "pack.nav.home": "Domov",
  "pack.nav.portal": "Portál",
  "pack.nav.profile": "Profil",
  "pack.nav.yourAvatar": "Tvoj avatar",
  "pack.nav.jumpToNationStats": "Prejsť na štatistiky národa",
  "pack.nav.bonesCount": "{count} BONES",
  "pack.nav.dog": "Pes",
  "pack.hero.toast.photoUpdated": "Fotka aktualizovaná",
  "pack.hero.toast.uploadFailed": "Nahrávanie zlyhalo",
  "pack.hero.toast.unknownError": "Neznáma chyba",
  "pack.hero.toast.nameUpdated": "Meno aktualizované",
  "pack.hero.toast.couldNotSave": "Nepodarilo sa uložiť",
  "pack.hero.editAvatar": "Upraviť avatar",
  "pack.hero.welcomeBack": "Vitaj späť",
  "pack.hero.namePlaceholder": "Tvoje meno",
  "pack.hero.saveName": "Uložiť meno",
  "pack.hero.editName": "Upraviť meno",
  "pack.hero.statusPawtner": "Pawtner",
  "pack.hero.bonesAria": "{bones} BONES",
  "pack.hero.devotionAria": "Oddanosť {devotion}, úroveň {index} {name}",
  "pack.hero.devotionTip": "Oddanosť",
  "pack.hero.toNext": "{count} ☥ do úrovne {name}",
  "pack.hero.maxDevotion": "Dosiahnutá najvyššia oddanosť",
  "pack.tree.title": "Môj Pack",
  "pack.tree.unnamed": "Bez mena",
  "pack.tree.profileLink.title": "Otvoriť profil psa — certifikáty, PDFs, fotky",
  "pack.tree.profileLink.ariaLabel": "Otvoriť profil psa",
  "pack.tree.noPhoto": "BEZ FOTKY",
  "pack.tree.heroglyphAlt": "Heroglyph psa {name}",
  "pack.tree.empty": "Zatiaľ žiadne Heroglyphs",
  "pack.tree.addDog": "Pridať psa",
  "pack.tree.addHumanMember": "Pridať ľudského člena",
  "pack.tree.comingSoonTooltip": "Už čoskoro — pozvi jedného ľudského člena",
  "pack.tree.ownerAvatarAlt": "majiteľ",
  "pack.verse.ariaLabel": "Verš dňa",
  "pack.verse.eyebrow": "Verš dňa",
  "pack.verse.unknownAuthor": "Neznámy",
  "pack.globe.milestone.founders": "Zakladatelia",
  "pack.globe.milestone.pack": "Pack",
  "pack.globe.milestone.nation": "Národ",
  "pack.globe.milestone.dynasty": "Dynastia",
  "pack.globe.canvasLabel": "Pack po celom svete",
  "pack.globe.roadToMillion": "Cesta k miliónu",
  "pack.globe.milestoneDot": "Míľnik {num}",
  "pack.globe.prevMilestone": "Predchádzajúci míľnik",
  "pack.globe.nextMilestone": "Ďalší míľnik",
  "pack.globe.achieved": "DOSIAHNUTÉ",
  "pack.globe.dogyptiansWorldwide": "Dogyptians<br />po celom svete",
  "pack.globe.nation": "národ",
  "pack.globe.topCountries": "Top krajiny",
  "pack.globe.topBreeds": "Top plemená",
  "pack.survey.heading": "Formuj aplikáciu",
  "pack.survey.subheading": "Čo máme postaviť ako prvé?",
  "pack.survey.toggle.vote": "Hlasovať",
  "pack.survey.toggle.results": "Výsledky",
  "pack.survey.feature.mobileApp.title": "Mobilná aplikácia",
  "pack.survey.feature.mobileApp.blurb": "Sociálna sieť, mapa miest priateľských k psom a správy v Packu — Pack vo tvojom vrecku.",
  "pack.survey.feature.healthAi.title": "Zdravotný protokol cez AI",
  "pack.survey.feature.healthAi.blurb": "Plán dlhovekosti pre tvojho psa poháňaný AI — plus dôveryhodná sieť veterinárov.",
  "pack.survey.feature.merch.title": "Merch",
  "pack.survey.feature.merch.blurb": "Heroglyph tlače, obojky, knihy a posvätné doplnky.",
  "pack.survey.voted": "Zahlasované",
  "pack.survey.voteForThis": "Hlasujem za toto",
  "pack.survey.dot.goTo": "Prejsť na {name}",
  "pack.survey.footer.collecting": "Zbierame do {date} — potom staviame.",
  "pack.survey.footer.votes": "{count} hlasov",
  "pack.survey.nav.previous": "Späť",
  "pack.survey.nav.next": "Ďalej",
  "pack.invite.copied": "Odkaz skopírovaný",
  "pack.invite.copiedDesc": "Zdieľaj ho a rozrastaj Pack.",
  "pack.invite.copyError": "Nepodarilo sa skopírovať",
  "pack.invite.shareText": "Pridaj sa k Packu. Staň sa Dogyptian.",
  "pack.invite.close": "Zavrieť",
  "pack.invite.howLineWorks": "Ako funguje tvoja línia",
  "pack.invite.whereEuroGoes": "Kam ide každé euro",
  "pack.invite.hekthorAlt": "Hekthor — zakladateľ #1",
  "pack.invite.growHeading": "Rozrastaj Pack.",
  "pack.invite.growBody": "Každý Dogyptian, ktorého privedieš, ti prinesie <strong style=\"color: hsl(45 95% 88%)\">BONES</strong> — a tak aj každý, koho privedú oni po tebe. Labka k labke dosiahneme milión.",
  "pack.invite.level1": "Úroveň 1",
  "pack.invite.level1Sub": "priamo",
  "pack.invite.level2": "Úroveň 2",
  "pack.invite.level2Sub": "ich privedení",
  "pack.invite.viewNetworkAria": "Zobraziť tvoju sieť — už čoskoro",
  "pack.invite.viewNetwork": "Zobraziť tvoju sieť · čoskoro",
  "pack.invite.generatingLink": "Generuje sa tvoj odkaz…",
  "pack.invite.copyLinkAria": "Kopírovať pozývací odkaz",
  "pack.invite.shareLink": "Zdieľaj svoj odkaz",
  "pack.invite.apostlesRewards": "Odmeny pre najlepších apoštolov sa odomykajú, ako náboženstvo rastie.",
  "pack.invite.transparency": "Transparentnosť",
  "pack.invite.whereEveryGoes": "Kam ide každé {price}?",
  "pack.invite.tapBlock": "Klepni na blok a uvidíš, kam to ide.",
  "pack.invite.yourLine": "Tvoja línia",
  "pack.invite.lineIntro": "Priveď milovníka psov — a zarábaj z každého, koho privedú po ňom.",
  "pack.invite.nodeYou": "Ty",
  "pack.invite.nodeFriend": "Priateľ",
  "pack.invite.nodeTheirFriend": "Ich priateľ",
  "pack.invite.brings": "privedie",
  "pack.invite.lineExample": "Privedieš <strong style=\"color: #7FA8FF\">Miu</strong> → zarobíš <strong style=\"color: #7FA8FF\">+20 BONES</strong>. Mia privedie <strong style=\"color: #E8836F\">Jakuba</strong> → zarobíš <strong style=\"color: #E8836F\">+10</strong> navyše. Tvoja línia ti platí ďalej — labka k labke.",
  "pack.invite.bonesValue": "10 BONES = €1 — utrať ich vnútri DOGYPT.",
  "pack.steps.eyebrow": "Tvoj profil",
  "pack.steps.title": "Prvé kroky",
  "pack.steps.rewardComplete": "Prvé kroky dokončené — ďalšia kapitola aplikácie príde už čoskoro.",
  "pack.steps.rewardPending": "Dokonči všetky Prvé kroky = <strong style=\"font-weight:800\">+10 ☥ Oddanosti</strong> do tvojho profilu.",
  "pack.constitution.coverAlt": "DOGMA — Dogyptian Ústava",
  "pack.constitution.readCta": "Prečítaj si DOGMA",
  "pack.constitution.description": "Základ celej viery — každý Dogyptian by si ju mal prečítať. Filozofia, logika aj to, ako funguje oddanosť, sa začínajú tu.",
  ...
  "pack.build.thanks": "Máme to — ďakujeme. Čítame každé slovo.",
  "pack.build.placeholder": "Chyba alebo nápad… pri chybách pridaj svoje zariadenie a prehliadač.",
  "pack.build.previewAlt": "náhľad prílohy",
  "pack.build.removePhoto": "Odstrániť fotku",
  "pack.build.attach": "Priložiť fotku ako dôkaz",
  "pack.build.error": "Niečo sa pokazilo. Skús to znova.",
  "pack.build.uploading": "Nahráva sa…",
  "pack.build.sending": "Odosiela sa…",
  "pack.build.send": "Odoslať spätnú väzbu",
  "pack.build.councilPrompt": "Chceš pomôcť formovať to?",
  ...
  "pack.settings.password.setChange": "Nastaviť / Zmeniť",
  "pack.settings.field.language": "Jazyk",
  "pack.settings.badge.lockedV0": "Zamknuté v0",
  "pack.settings.field.notifications": "Notifikácie",
  "pack.settings.badge.comingSoon": "Už čoskoro",
  "pack.settings.field.signOut": "Odhlásiť sa",
  "pack.settings.signOut.button": "Odhlásiť sa",
  "pack.settings.modal.title": "Heslo",
  "pack.settings.modal.close": "Zavrieť",
  "pack.settings.modal.descWelcome": "Dokonči svoj účet — nastav si heslo, aby si sa mohol prihlásiť kedykoľvek bez e-mailového odkazu.",
  "pack.settings.modal.desc": "Nastav alebo zmeň svoje heslo pre prihlásenie e-mailom + heslom.",
  "pack.settings.modal.newPasswordPlaceholder": "Nové heslo (min. 8 znakov)",
  "pack.settings.modal.confirmPasswordPlaceholder": "Potvrď heslo",
  "pack.settings.modal.submit": "Nastaviť heslo",
  "pack.settings.error.minLength": "Heslo musí mať aspoň 8 znakov.",
  "pack.settings.error.noMatch": "Heslá sa nezhodujú.",
  "pack.settings.error.generic": "Nepodarilo sa nastaviť heslo.",
  "pack.settings.toast.title": "Heslo nastavené",
  "pack.settings.toast.description": "Teraz sa môžeš prihlásiť e-mailom + heslom.",
  "pack.dog.shield.parasites": "Parazity",
  "pack.dog.shield.parasites.note": "Ďalšia antiparazitárna dávka a pripomienky.",
  "pack.dog.shield.vaccine": "Očkovanie",
  "pack.dog.shield.vaccine.note": "Termín preočkovania a celý záznam o očkovaní.",
  "pack.dog.shield.immunity": "Imunita",
  "pack.dog.shield.immunity.note": "Celková imunitná pripravenosť.",
  "pack.dog.shield.joints": "Starostlivosť o kĺby",
  "pack.dog.shield.joints.note": "Doplnky na podporu kĺbov a načasovanie.",
  "pack.dog.shield.comingSoon": "{label} — už čoskoro",
  "pack.dog.toast.logFailed": "Nepodarilo sa zaznamenať — skús znova",
  "pack.dog.toast.saved": "Uložené",
  "pack.dog.toast.couldNotSave": "Nepodarilo sa uložiť",
  "pack.dog.toast.unknownError": "Neznáma chyba",
  "pack.dog.toast.messageSaved": "Správa uložená",
  "pack.dog.toast.messageSaved.desc": "Viditeľná na tvojej WALL karte.",
  "pack.dog.toast.photoAdded": "Fotka pridaná",
  "pack.dog.toast.uploadFailed": "Nahrávanie zlyhalo",
  "pack.dog.toast.couldNotRemove": "Nepodarilo sa odstrániť",
  "pack.dog.toast.photoUpdated": "Fotka aktualizovaná",
  "pack.dog.toast.photoUpdated.desc": "Obnova WALL a certifikátu — už čoskoro.",
  "pack.dog.toast.certReady": "Certifikát pripravený",
  "pack.dog.toast.certReady.desc": "Tvoje PDFs boli vygenerované.",
  "pack.dog.toast.couldNotGenerate": "Nepodarilo sa vygenerovať PDFs",
  "pack.dog.toast.emailResent": "E-mail znova odoslaný",
  "pack.dog.toast.emailResent.desc": "O chvíľu skontroluj svoju schránku.",
  "pack.dog.toast.couldNotResend": "Nepodarilo sa znova odoslať",
  "pack.dog.toast.comingSoon": "Už čoskoro",
  "pack.dog.loading": "NAČÍTAVA SA",
  "pack.dog.unnamed": "Bez mena",
  "pack.dog.viewOnWall": "Zobraziť na Wall {certNumber}",
  "pack.dog.passport.label": "Pas tvojho psa — globálna databáza. Už čoskoro.",
  "pack.dog.lost.label": "Stratený pes — vyhlás pátranie, upozorni Pack. Už čoskoro.",
  "pack.dog.profileDocs": "Profil a dokumenty",
  "pack.dog.changePhoto": "Zmeniť fotku",
  "pack.dog.noPhoto": "BEZ FOTKY",
  "pack.dog.livingBestLife": "Žijem si svoj najlepší život",
  "pack.dog.birthdayUnknown": "Narodeniny neznáme.",
  "pack.dog.backToProfile": "Späť na profil",
  "pack.dog.doc.certificate": "Certifikát",
  "pack.dog.doc.vertical": "Na výšku",
  "pack.dog.doc.horizontal": "Na šírku",
  "pack.dog.hideCert": "Skryť certifikát",
  "pack.dog.viewCert": "Zobraziť certifikát",
  "pack.dog.generating": "Generuje sa…",
  "pack.dog.regeneratePdfs": "Pregenerovať PDFs",
  "pack.dog.generatePdfs": "Generovať PDFs",
  "pack.dog.wordOnWall": "Slovo na Wall",
  "pack.dog.wallPlaceholder": "Pár slov zobrazených na tvojej WALL karte — pocta, spomienka, pozdrav Packu.",
  "pack.dog.saving": "Ukladá sa",
  "pack.dog.save": "Uložiť",
  "pack.dog.prayers.title": "Aký nádherný čas byť nažive.",
  "pack.dog.prayers.subtitle": "Dnešné modlitby — malé skutky oddanosti pre {dogName}.",
  "pack.dog.prayer.presence.title": "Modlitba prítomnosti",
  "pack.dog.prayer.presence.hint": "10 minút plnej pozornosti — hra, tréning, len byť. Žiadny telefón. Toto je Modlitba prítomnosti.",
  "pack.dog.prayer.walk.title": "Prechádzka",
  "pack.dog.prayer.walk.hint": "Posuň, ako dlho ste sa prechádzali. Pod hodinu prinesie 0,5 — potom 1 bod za hodinu, až do 5 za celodennú výpravu.",
  "pack.dog.walk.day": "Deň",
  "pack.dog.prayer.ritual.title": "Otvorený rituál",
  "pack.dog.prayer.ritual.hint": "Pridaj si vlastné skutky oddanosti — vyber z ďalších rituálov alebo si vytvor vlastný.",
  "pack.dog.prayer.ritual.toastDesc": "Ďalšie rituály — aj tvoje vlastné — sú na ceste.",
  "pack.dog.choose": "Vybrať",
  "pack.dog.devotion.logged": "Zaznamenané na dnes ✓ +{points} ☥",
  "pack.dog.devotion.today": "{points} Oddanosti dnes",
  "pack.dog.submit": "Odoslať",
  "pack.dog.lockedForToday": "Zamknuté na dnes · obnoví sa zajtra",
  "pack.dog.addsToStats": "Pripočíta sa k tvojim štatistikám",
  "pack.dog.confirm.title": "Zaznamenať dnešné modlitby?",
  "pack.dog.confirm.body": "Toto je konečné — dnešnú oddanosť už nemožno zmeniť.",
  "pack.dog.cancel": "Zrušiť",
  "pack.dog.confirm.cta": "Zaznamenať modlitby",
  "pack.dog.tile.health": "Zdravie",
  "pack.dog.tile.health.sub": "Očkovania · Veterinár · Strava",
  "pack.dog.tile.training": "Tréning",
  "pack.dog.tile.training.sub": "Povely · Odznaky",
  "pack.dog.tile.journal": "Denník",
  "pack.dog.tile.journal.sub": "Príbehy · Fotky",
  "pack.dog.health.tagline": "Celý zdravotný záznam na jednom mieste — nič sa nestratí, nič nechýba.",
  "pack.dog.overview": "Prehľad",
  "pack.dog.shareVet.toastDesc": "Zdieľaj s veterinárom zdravotný profil len na čítanie.",
  "pack.dog.shareWithVet": "Zdieľať s veterinárom",
  "pack.dog.fact.breed": "Plemeno",
  "pack.dog.fact.born": "Narodený",
  "pack.dog.fact.weight": "Hmotnosť",
  "pack.dog.saveWeight": "Uložiť hmotnosť",
  ...
  "pack.dog.fact.conditions": "Ochorenia",
  "pack.dog.fact.medication": "Lieky",
  "pack.dog.test.personality": "Osobnosť",
  "pack.dog.makeTest": "Spraviť test",
  "pack.dog.test.personality.sub": "TCM elementy — oheň, kov, drevo…",
  "pack.dog.test.personality.toastTitle": "Test osobnosti — už čoskoro",
  "pack.dog.test.personality.toastDesc": "Krátky kvíz zaradí tvojho psa k piatim elementom.",
  "pack.dog.test.identity": "Identita",
  "pack.dog.test.identity.sub": "Zisti {poss} typ charakteru",
  "pack.dog.test.identity.toastTitle": "Test identity — už čoskoro",
  "pack.dog.test.identity.toastDesc": "Preklikaj sa pár otázkami a urči {poss} typ charakteru.",
  "pack.dog.vetCentre.title": "Veterinárne centrum",
  "pack.dog.vetCentre.desc": "Očkovania a návštevy — plánované aj minulé — v jednej časovej osi, ktorú môžeš zdieľať s každým veterinárom.",
  "pack.dog.foodProtocol.title": "Stravovací protokol",
  "pack.dog.foodProtocol.desc": "Značka, porcie a alergie — strava, ktorej môže celý Pack veriť.",
  "pack.dog.health.vision.title": "Zdravotný protokol cez AI + sieť veterinárov, ktorým dôveruješ",
  "pack.dog.health.vision.body": "Plán dlhovekosti pre tvojho psa poháňaný AI — a prvopomocná sieť veterinárov po celom národe. Celý zmysel milióna Dogyptians.",
  "pack.dog.training.tagline": "Každý naučený povel, každá vyhraná skúška — zapísané.",
  "pack.dog.training.commands": "Povely",
  "pack.dog.training.commands.desc": "Sadni, zostaň, privolanie, k nohe… odškrtni ich, ako každý {subj} zvládne.",
  "pack.dog.training.badges": "Posvätné odznaky",
  "pack.dog.training.badges.desc": "Výstavy, preteky, skúšky poslušnosti, navštívené krajiny — vyslúžené, nikdy kúpené.",
  "pack.dog.training.obedience": "Poslušnosť",
  "pack.dog.training.agility": "Agility",
  "pack.dog.soon": "Čoskoro",
  "pack.dog.training.vision.title": "Odznaky kŕmia tvoju Oddanosť",
  "pack.dog.training.vision.body": "Skúšky a míľniky sa stávajú posvätnými odznakmi na tvojom profile — a Oddanosťou v Packu. Kánon sa práve píše.",
  "pack.dog.journal.tagline": "Každý príbeh, každá fotka — {poss} celý život, uchovaný.",
  "pack.dog.instantStory": "Okamžitý príbeh",
  "pack.dog.instantStory.body": "Len vyrozprávaj ten moment — rýchla hlasová poznámka, ktorá sa zaznamená pod dnešným dátumom a premení sa na text, raz možno na stranu {poss} knihy. Pridaj pár fotiek a deň je uložený navždy.",
  "pack.dog.instantStory.toastTitle": "Okamžitý príbeh — už čoskoro",
  "pack.dog.instantStory.toastDesc": "Nahraj hlasovú poznámku a zaznamená sa pod dnešným dátumom.",
  "pack.dog.recordStory": "Nahrať príbeh",
  "pack.dog.addPhotos": "Pridať fotky",
  "pack.dog.addPhotos.toastDesc": "Priraď fotky k momentu.",
  "pack.dog.storyEarnsDevotion": "Každý príbeh prináša Oddanosť.",
  "pack.dog.storyArchive": "Archív príbehov",
  "pack.dog.storyArchive.empty": "{poss} príbehy budú žiť tu — najnovšie ako prvé, každá hlasová poznámka a fotka podľa dátumu.",
  "pack.dog.photoAlbum": "Fotoalbum",
  "pack.dog.addPhoto": "Pridať fotku",
  "pack.dog.noPhotosYet": "Zatiaľ žiadne fotky.",
  "pack.dog.stats": "ŠTATISTIKY",
  "pack.dog.stats.subtitle": "Každý deň, ktorý zaznamenáš, žiari — živý kalendár tvojej oddanosti.",
  "pack.dog.comingSoon": "Už čoskoro",
  "pack.dog.resendEmail": "Znova odoslať e-mail",
  "pack.dog.showAgeDetail": "Zobraziť detail veku",
  "pack.dog.daysCount": "{days} dní",
  "pack.dog.ageDetail": "{years}r {months}m {days}d · ≈ {humanYears} ľudských rokov",
  "pack.dog.legend": "Legenda",
  "pack.dog.legend.trip": "Výlet",
  "pack.dog.legend.trip.desc": "Dlhý deň v divočine",
  "pack.dog.legend.walk": "Prechádzka",
  "pack.dog.legend.walk.desc": "Poriadna denná prechádzka",
  "pack.dog.legend.stroll": "Vychádzka",
  "pack.dog.legend.stroll.desc": "Rýchle kolečko okolo bloku",
  "pack.dog.legend.vet": "Veterinár",
  "pack.dog.legend.vet.desc": "Zdravie a prehliadky",
  "pack.dog.legend.birthday": "Narodeniny",
  "pack.dog.legend.birthday.desc": "Tie skutočné",
  "pack.dog.legend.humanYear": "Ľudský rok",
  "pack.dog.legend.humanYear.desc": "1 zo 7 — naplánuj niečo",
  "pack.dog.addActivity": "Pridať aktivitu",
  "pack.dog.addActivity.sub": "Názov, farba a ikona — už čoskoro",
  "pack.dog.health.healthy": "Zdravý",
  "pack.dog.health.injury": "Zranenie",
  "pack.dog.health.gastro": "Žalúdok",
  "pack.dog.health.allergy": "Alergia",
  "pack.dog.health.other": "Iné",
  "pack.dog.health.visionNote": "Jedného dňa, keď označíš svojho psa za chorého, upozorní to DOGYPT liečiteľov vo tvojej blízkosti — a naša AI sa ozve, aby pomohla. Globálna prvopomocná sieť pre psov.",
  "pack.dog.visionNotLive": "Vízia · zatiaľ nie je v prevádzke",
  "pack.dog.stillAlive": "Stále nažive",
  "pack.dog.stillAliveTooltip": "Stále nažive, pripravený zabávať sa",
  "pack.dog.live": "Naživo",
  "pack.dog.dailyPrayers": "Denné modlitby",
  "pack.dog.dailyPrayers.body": "Denné skutky oddanosti pre {dogName} — prítomnosť, prechádzka a rituál — sú na ceste.",
  "pack.dog.main": "HLAVNÉ",
  "pack.dog.removePhoto": "Odstrániť fotku",
  "pack.dog.officialRecord": "Oficiálny záznam",
  "pack.dog.notFound.title": "Nenájdené",
  "pack.dog.notFound.body": "Tento Heroglyph buď nie je tvoj, alebo už neexistuje.",
  "pack.dog.backToPack": "Späť do Packu",
  "pack.dog.error.body": "Pri načítavaní tohto Heroglyphu sa niečo pokazilo.",
