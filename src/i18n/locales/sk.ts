...
export const sk: Partial<Dict> = {
  ...
  "pack.spotlight.eyebrowTip": "Kam ste ešte neboli",
  ...
  "pack.spotlight.mapTitle": "Rozšír hranice",
  ...
  "pack.hero.popLevel1": "Úroveň rastie s oddanosťou (☥) — od Novica až po Poloboha. Rebríček má 22 stupňov a je rovnaký pre všetkých.",
  "pack.hero.popLevel2": "Stupeň sa nedá kúpiť. Prejde sa.",
  ...
  'pack.hub.passComplete': "Vysvedčenie kompletné",
