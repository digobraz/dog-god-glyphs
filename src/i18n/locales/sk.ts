...
export const sk: Partial<Dict> = {
  ...
  'pack.addTrip.entry.planned.title': "IDEME NIEKAM",
  'pack.addTrip.entry.planned.text': "Plánuješ výlet — nájdi ľudí, s ktorými pôjdeš",
  'pack.addTrip.entry.walked.title': "UŽ SME TAM BOLI",
  'pack.addTrip.entry.walked.text': "Zapíš prechádzku, ktorú si už absolvoval",
