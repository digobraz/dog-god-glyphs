...
export const en = {
  ...
  // ── /pack/dogs/:id — PackDogDetail (dog profile) ──
  'pack.dog.shield.parasites': 'Parasites',
  'pack.dog.shield.parasites.note': 'Next anti-parasite dose and reminders.',
  'pack.dog.shield.vaccine': 'Vaccination',
  'pack.dog.shield.vaccine.note': 'Booster window and the full vaccination record.',
  'pack.dog.shield.immunity': 'Immunity',
  'pack.dog.shield.immunity.note': 'Overall immune readiness.',
  'pack.dog.shield.joints': 'Joint care',
  'pack.dog.shield.joints.note': 'Joint-support supplements and timing.',
  'pack.dog.shield.comingSoon': '{label} — coming soon',
  'pack.dog.toast.logFailed': 'Couldn\'t log — try again',
  'pack.dog.toast.saved': 'Saved',
  'pack.dog.toast.couldNotSave': 'Could not save',
  'pack.dog.toast.unknownError': 'Unknown error',
  'pack.dog.toast.messageSaved': 'Message saved',
  'pack.dog.toast.messageSaved.desc': 'Visible on your WALL card.',
  'pack.dog.toast.photoAdded': 'Photo added',
  'pack.dog.toast.uploadFailed': 'Upload failed',
  'pack.dog.toast.couldNotRemove': 'Could not remove',
  'pack.dog.toast.photoUpdated': 'Photo updated',
  'pack.dog.toast.photoUpdated.desc': 'Wall & certificate refresh — coming soon.',
  'pack.dog.toast.certReady': 'Certificate ready',
  'pack.dog.toast.certReady.desc': 'Your PDFs have been generated.',
  'pack.dog.toast.couldNotGenerate': 'Could not generate PDFs',
  'pack.dog.toast.emailResent': 'Email re-sent',
  'pack.dog.toast.emailResent.desc': 'Check your inbox in a moment.',
  'pack.dog.toast.couldNotResend': 'Could not re-send',
  'pack.dog.toast.comingSoon': 'Coming soon',
  'pack.dog.loading': 'LOADING',
  'pack.dog.unnamed': 'Unnamed',
  'pack.dog.viewOnWall': 'View on Wall {certNumber}',
  'pack.dog.passport.label': 'Your dog\'s passport — a global database. Coming soon.',
  'pack.dog.lost.label': 'Lost dog — declare a search, alert the pack. Coming soon.',
  'pack.dog.profileDocs': 'Profile & documents',
  'pack.dog.changePhoto': 'Change photo',
  'pack.dog.noPhoto': 'NO PHOTO',
  'pack.dog.livingBestLife': 'Living my best life',
  'pack.dog.birthdayUnknown': 'Birthday unknown.',
  'pack.dog.backToProfile': 'Back to profile',
  'pack.dog.doc.certificate': 'Certificate',
  'pack.dog.doc.vertical': 'Vertical',
  'pack.dog.doc.horizontal': 'Horizontal',
  'pack.dog.hideCert': 'Hide certificate',
  'pack.dog.viewCert': 'View certificate',
  ...
  'pack.dog.save': 'Save',
  'pack.dog.prayers.title': 'What a wonderful time to be alive.',
  'pack.dog.prayers.subtitle': 'Today\'s prayers — small acts of devotion to {dogName}.',
  'pack.dog.prayer.presence.title': 'Prayer of Presence',
  'pack.dog.prayer.presence.hint': '10 minutes of full attention — play, train, just be. No phone. This is the Prayer of Presence.',
  'pack.dog.prayer.walk.title': 'Walk',
  'pack.dog.prayer.walk.hint': 'Slide how long you walked. Under an hour earns 0.5 — then 1 point per hour, up to 5 for an all-day journey.',
  'pack.dog.walk.day': 'Day',
  'pack.dog.prayer.ritual.title': 'Open Ritual',
  'pack.dog.prayer.ritual.hint': 'Add your own acts of devotion — choose from more rituals or create a custom one.',
  'pack.dog.prayer.ritual.toastDesc': 'More rituals — and your own custom ones — are on the way.',
  'pack.dog.choose': 'Choose',
  'pack.dog.devotion.logged': 'Logged for today ✓ +{points} ☥',
  'pack.dog.devotion.today': '{points} Devotion today',
  'pack.dog.submit': 'Submit',
  'pack.dog.lockedForToday': 'Locked for today · resets tomorrow',
  'pack.dog.addsToStats': 'Adds to your stats',
  'pack.dog.confirm.title': 'Log today\'s prayers?',
  'pack.dog.confirm.body': 'This is final — today\'s devotion can\'t be changed.',
  'pack.dog.cancel': 'Cancel',
  'pack.dog.confirm.cta': 'Log prayers',
  'pack.dog.tile.health': 'Health',
  'pack.dog.tile.health.sub': 'Vaccines · Vet · Food',
  'pack.dog.tile.training': 'Training',
  'pack.dog.tile.training.sub': 'Commands · Badges',
  'pack.dog.tile.journal': 'Journal',
  'pack.dog.tile.journal.sub': 'Stories · Photos',
  'pack.dog.health.tagline': 'The whole health record in one place — nothing lost, nothing missing.',
  'pack.dog.overview': 'Overview',
  'pack.dog.shareVet.toastDesc': 'Share a read-only health profile with your vet.',
  'pack.dog.shareWithVet': 'Share with vet',
  'pack.dog.fact.breed': 'Breed',
  'pack.dog.fact.born': 'Born',
  'pack.dog.fact.weight': 'Weight',
  'pack.dog.saveWeight': 'Save weight',
  'pack.dog.addWeight': '— Add weight',
  'pack.dog.fact.diet': 'Diet',
  'pack.dog.addDiet': 'Add diet…',
  'pack.dog.protection': 'Protection',
  'pack.dog.preview': 'Preview',
  'pack.dog.fact.allergies': 'Allergies',
  'pack.dog.fact.conditions': 'Conditions',
  'pack.dog.fact.medication': 'Medication',
  'pack.dog.test.personality': 'Personality',
  'pack.dog.makeTest': 'Make test',
  'pack.dog.test.personality.sub': 'TCM elements — fire, metal, wood…',
  'pack.dog.test.personality.toastTitle': 'Personality test — coming soon',
  'pack.dog.test.personality.toastDesc': 'A short quiz maps your dog onto the five elements.',
  'pack.dog.test.identity': 'Identity',
  'pack.dog.test.identity.sub': 'Find {poss} character type',
  'pack.dog.test.identity.toastTitle': 'Identity test — coming soon',
  'pack.dog.test.identity.toastDesc': 'Click through a few questions to place {poss} character type.',
  'pack.dog.vetCentre.title': 'Vet centre',
  'pack.dog.vetCentre.desc': 'Vaccinations and visits — planned and past — in one timeline you can share with any vet.',
  'pack.dog.foodProtocol.title': 'Food protocol',
  'pack.dog.foodProtocol.desc': 'Brand, portions and allergies — the diet the whole pack can trust.',
  'pack.dog.health.vision.title': 'Health Protocol by AI + a vet network you trust',
  'pack.dog.health.vision.body': 'A longevity blueprint for your dog, powered by AI — and a First-Aid network of vets across the nation. The whole point of a million Dogyptians.',
  'pack.dog.training.tagline': 'Every command learned, every trial won — written down.',
  'pack.dog.training.commands': 'Commands',
  'pack.dog.training.commands.desc': 'Sit, stay, recall, heel… tick them off as {subj} masters each one.',
  'pack.dog.training.badges': 'Sacred badges',
  'pack.dog.training.badges.desc': 'Shows, races, obedience trials, countries visited — earned, never bought.',
  'pack.dog.training.obedience': 'Obedience',
  'pack.dog.training.agility': 'Agility',
  'pack.dog.soon': 'Soon',
  'pack.dog.training.vision.title': 'Badges feed your Devotion',
  'pack.dog.training.vision.body': 'Trials and milestones become sacred badges on your profile — and Devotion in the pack. The canon is being written.',
  'pack.dog.journal.tagline': 'Every story, every photo — {poss} whole life, kept.',
  'pack.dog.instantStory': 'Instant Story',
  'pack.dog.instantStory.body': 'Just speak the moment — a quick voice note that logs under today\'s date and turns into text, one day maybe a page of {poss} book. Add a few photos and the day is saved forever.',
  'pack.dog.instantStory.toastTitle': 'Instant Story — coming soon',
  'pack.dog.instantStory.toastDesc': 'Record a voice note and it logs under today’s date.',
  'pack.dog.recordStory': 'Record a story',
  'pack.dog.addPhotos': 'Add photos',
  'pack.dog.addPhotos.toastDesc': 'Attach photos to the moment.',
  'pack.dog.storyEarnsDevotion': 'Every story earns Devotion.',
  'pack.dog.storyArchive': 'Story archive',
  'pack.dog.storyArchive.empty': '{poss} stories will live here — newest first, every voice note and photo by date.',
  'pack.dog.photoAlbum': 'Photo Album',
  'pack.dog.addPhoto': 'Add photo',
  'pack.dog.noPhotosYet': 'No photos yet.',
  'pack.dog.stats': 'STATS',
  'pack.dog.stats.subtitle': 'Every day you log glows — a living calendar of your devotion.',
  'pack.dog.comingSoon': 'Coming soon',
  'pack.dog.resendEmail': 'Re-send email',
  'pack.dog.showAgeDetail': 'Show age detail',
  'pack.dog.daysCount': '{days} days',
  'pack.dog.ageDetail': '{years}y {months}m {days}d · ≈ {humanYears} human years',
  'pack.dog.legend': 'Legend',
  'pack.dog.legend.trip': 'Trip',
  'pack.dog.legend.trip.desc': 'A long day into the wild',
  'pack.dog.legend.walk': 'Walk',
  'pack.dog.legend.walk.desc': 'A proper daily walk',
  'pack.dog.legend.stroll': 'Stroll',
  'pack.dog.legend.stroll.desc': 'A quick round the block',
  'pack.dog.legend.vet': 'Vet',
  'pack.dog.legend.vet.desc': 'Health & check-ups',
  'pack.dog.legend.birthday': 'Birthday',
  'pack.dog.legend.birthday.desc': 'The real one',
  'pack.dog.legend.humanYear': 'Human year',
  'pack.dog.legend.humanYear.desc': '1 of 7 — plan something',
  'pack.dog.addActivity': 'Add activity',
  'pack.dog.addActivity.sub': 'Name, colour & icon — coming soon',
  'pack.dog.health.healthy': 'Healthy',
  'pack.dog.health.injury': 'Injury',
  'pack.dog.health.gastro': 'Gastro',
  'pack.dog.health.allergy': 'Allergy',
  'pack.dog.health.other': 'Other',
  'pack.dog.health.visionNote': 'One day, marking your dog unwell will alert DOGYPT healers near you — and our AI will reach out to help. A global first-aid network for dogs.',
  'pack.dog.visionNotLive': 'Vision · not live yet',
  'pack.dog.stillAlive': 'Still alive',
  'pack.dog.stillAliveTooltip': 'Still alive, ready to have fun',
  'pack.dog.live': 'Live',
  'pack.dog.dailyPrayers': 'Daily Prayers',
  'pack.dog.dailyPrayers.body': 'The daily acts of devotion to {dogName} — presence, the walk, and ritual — are on the way.',
  'pack.dog.main': 'MAIN',
  'pack.dog.removePhoto': 'Remove photo',
  'pack.dog.officialRecord': 'The official record',
  'pack.dog.notFound.title': 'Not Found',
  'pack.dog.notFound.body': 'This heroglyph is either not yours or no longer exists.',
  'pack.dog.backToPack': 'Back to Pack',
  'pack.dog.error.body': 'Something went wrong while loading this heroglyph.',
