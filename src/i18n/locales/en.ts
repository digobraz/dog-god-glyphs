...
export const en = {
  ...
  'pack.invite.statLevel1': "First circle",
  'pack.invite.statLevel1Sub': "direct",
  'pack.invite.statLevel2': "Second circle",
  ...
  'pack.network.lineSplit': "{l1} in first circle · {l2} in second",
  'pack.network.circle1': "First circle — your direct invites",
  'pack.network.circle2': "Second circle — invites from your first circle",
