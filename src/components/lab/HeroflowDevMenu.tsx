...
const GROUPS: Group[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { kind: 'route', path: '/heroglyph/reveal', name: 'Odhalenie + odkaz' },
      { kind: 'route', path: '/heroglyph/message', name: 'Odkaz (starý)' },
      { kind: 'route', path: '/checkout', name: 'Pokladňa' },
      { kind: 'route', path: '/heroglyph/stay', name: 'Zadržanie' },
      { kind: 'route', path: '/payment', name: 'Platba (starý)' },
