...
export const en = {
  ...
  'pack.addTrip.entry.planned.title': "WE'RE HEADING OUT",
  'pack.addTrip.entry.planned.text': "Planning a trip — find people to walk with",
  'pack.addTrip.entry.walked.title': "WE'VE BEEN THERE",
  'pack.addTrip.entry.walked.text': "Log a walk you already did",
