...
export const esp: Partial<Dict> = {
  ...
  'consent.body':
    'Con tu consentimiento podemos estudiar y medir cómo se usa el sitio — para arreglar lo que no funciona y mejorar nuestro templo digital. Gracias por tu colaboración.',
  ...
  "pack.invite.statLevel1": "Primer círculo",
  "pack.network.circle2": "Segundo círculo — las invitaciones de tu primer círculo",
  "pack.network.circle1": "Primer círculo — tus invitaciones directas",
  "pack.network.lineSplit": "{l1} en el primer círculo · {l2} en el segundo",
