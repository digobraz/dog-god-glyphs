...
export const rus: Partial<Dict> = {
  ...
  "pack.invite.statLevel1": "Первый круг",
  "pack.network.circle2": "Второй круг — приглашения твоего первого круга",
  "pack.network.circle1": "Первый круг — твои прямые приглашения",
  "pack.network.lineSplit": "{l1} в первом круге · {l2} во втором",
  "pack.invite.statLevel1Sub": "напрямую",
  "pack.invite.statLevel2": "Второй круг",
