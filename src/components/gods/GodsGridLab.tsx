    ...
    <>
      ...
      <div className={`gods-root theme-${theme}`}>
        ...
        <div className="gods-bottom-bar">
          ...
          {/* LAB: tretia ikonka — PLANÉTA PSOV. Ikonka je z hand-drawn kitu
              (`public/icons/pack/world-grid.svg`), vložená inline, aby dedila
              farbu textu ako zvyšok ovládania v bare. */}
          <button
