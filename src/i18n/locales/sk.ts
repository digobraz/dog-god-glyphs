...
export const sk: Partial<Dict> = {
  ...
  'pack.mapNotes.kind.hazard': "Nebezpečenstvo",
  'pack.mapNotes.kind.note': "Poznámka",
  ...
  'pack.mapNotes.delete': "Zmazať moju poznámku",
  'pack.mapNotes.error': "Neuložilo sa. Skús to znova.",
  'pack.mapNotes.hint': "Podrž prst kdekoľvek na mape a nechaj odkaz pre svorku.",
  ...
  'pack.mapNotes.add.dragHint': "Ak značka nesedí presne, potiahni ju.",
  ...
  'pack.mapNotes.section.title': "Na mape",
  'pack.mapNotes.section.add': "Pridať na mapu",
  'pack.mapNotes.section.empty': "Sem ešte nikto nič nenapísal. Buď prvý.",
  'pack.mapNotes.fab.ready': "Nechaj tu odkaz",
  'pack.mapNotes.fab.locked': "Priblíž si mapu a písanie sa odomkne",
