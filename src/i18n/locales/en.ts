...
export const en = {
  ...
  'pack.steps.castVote': "Cast your vote in Shape",
  'pack.steps.flipConstitution': "Flip through the Constitution",
  'pack.steps.forgeHeroglyph': "Forge your first heroglyph",
  ...
  'pack.survey.featureMobileAppBlurb': "Social network, dog-friendly map & pack messaging — the pack in your pocket.",
  ...
  "pack.stats.split": "Why this split? Read 'Money is an Energy' in the Constitution →",
