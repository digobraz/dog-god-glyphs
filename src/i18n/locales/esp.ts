...
export const esp: Partial<Dict> = {
  ...
  "pack.page.steps.forge": "Forja tu primer Heroglyph",
  "pack.page.steps.photo": "Añade tu foto",
  "pack.page.steps.extras": "Añade más fotos de tu perro",
  "pack.page.steps.vote": "Emite tu voto en Shape",
  "pack.page.steps.constitution": "Hojea la Constitución",
  "pack.page.steps.invite": "Invita a tu primer amante de los perros",
  "pack.nav.loading": "CARGANDO…",
  "pack.nav.home": "Inicio",
  "pack.nav.portal": "Portal",
  "pack.nav.profile": "Perfil",
  "pack.nav.yourAvatar": "Tu avatar",
  "pack.nav.jumpToNationStats": "Ir a las estadísticas de la Nación",
  "pack.nav.bonesCount": "{count} BONES",
  "pack.nav.dog": "Perro",
  "pack.hero.toast.photoUpdated": "Foto actualizada",
  "pack.hero.toast.uploadFailed": "Error al subir",
  "pack.hero.toast.unknownError": "Error desconocido",
  "pack.hero.toast.nameUpdated": "Nombre actualizado",
  "pack.hero.toast.couldNotSave": "No se pudo guardar",
  "pack.hero.editAvatar": "Editar avatar",
  "pack.hero.welcomeBack": "Bienvenido de nuevo",
  "pack.hero.namePlaceholder": "Tu nombre",
  "pack.hero.saveName": "Guardar nombre",
  "pack.hero.editName": "Editar nombre",
  "pack.hero.statusPawtner": "Pawtner",
  "pack.hero.bonesAria": "{bones} BONES",
  "pack.hero.devotionAria": "Devoción {devotion}, nivel {index} {name}",
  "pack.hero.devotionTip": "Devoción",
  "pack.hero.toNext": "{count} ☥ para {name}",
  "pack.hero.maxDevotion": "Máxima devoción alcanzada",
  "pack.tree.title": "Mi Pack",
  "pack.tree.unnamed": "Sin nombre",
  "pack.tree.profileLink.title": "Abrir perfil del perro — certificados, PDFs, fotos",
  "pack.tree.profileLink.ariaLabel": "Abrir perfil del perro",
  "pack.tree.noPhoto": "SIN FOTO",
  "pack.tree.heroglyphAlt": "Heroglyph de {name}",
  "pack.tree.empty": "Aún no hay Heroglyphs",
  "pack.tree.addDog": "Añadir perro",
  "pack.tree.addHumanMember": "Añadir miembro humano",
  "pack.tree.comingSoonTooltip": "Próximamente — invita a un miembro humano",
  ...
  "pack.globe.milestone.founders": "Los Fundadores",
  "pack.globe.milestone.pack": "El Pack",
  "pack.globe.milestone.nation": "La Nación",
  "pack.globe.milestone.dynasty": "La Dinastía",
  "pack.globe.canvasLabel": "El Pack en todo el mundo",
  "pack.globe.roadToMillion": "El camino hacia el millón",
  "pack.globe.milestoneDot": "Hito {num}",
  "pack.globe.prevMilestone": "Hito anterior",
  "pack.globe.nextMilestone": "Hito siguiente",
  "pack.globe.achieved": "LOGRADO",
  "pack.globe.dogyptiansWorldwide": "Dogyptians<br />en todo el mundo",
  "pack.globe.nation": "nación",
  "pack.globe.topCountries": "Principales países",
  "pack.globe.topBreeds": "Principales razas",
  ...
  "pack.survey.feature.mobileApp.title": "App móvil",
  "pack.survey.feature.mobileApp.blurb": "Red social, mapa pet-friendly y mensajería del Pack — el Pack en tu bolsillo.",
  "pack.survey.feature.healthAi.title": "Protocolo de Salud por AI",
  "pack.survey.feature.healthAi.blurb": "Un plan de longevidad para tu perro, impulsado por AI — más una red veterinaria de confianza.",
  "pack.survey.feature.merch.title": "Merch",
  "pack.survey.feature.merch.blurb": "Láminas de Heroglyph, collares, libros y accesorios sagrados.",
  "pack.survey.voted": "Votado",
  "pack.survey.voteForThis": "Voto por esto",
  "pack.survey.dot.goTo": "Ir a {name}",
  "pack.survey.footer.collecting": "Recogiendo votos hasta {date} — luego lo construimos.",
  "pack.survey.footer.votes": "{count} votos",
  "pack.survey.nav.previous": "Anterior",
  "pack.survey.nav.next": "Siguiente",
  "pack.invite.copied": "Enlace copiado",
  "pack.invite.copiedDesc": "Compártelo y haz crecer el Pack.",
  "pack.invite.copyError": "No se pudo copiar",
  "pack.invite.shareText": "Únete al Pack. Hazte Dogyptian.",
  "pack.invite.close": "Cerrar",
  "pack.invite.howLineWorks": "Cómo funciona tu línea",
  "pack.invite.whereEuroGoes": "Adónde va cada euro",
  "pack.invite.hekthorAlt": "Hekthor — fundador #1",
  "pack.invite.growHeading": "Haz crecer el Pack.",
  "pack.invite.growBody": "Cada Dogyptian que traigas te da <strong style=\"color: hsl(45 95% 88%)\">BONES</strong> — y también todos los que ellos traigan después. Pata a pata, llegamos al millón.",
  "pack.invite.level1": "Nivel 1",
  "pack.invite.level1Sub": "directos",
  "pack.invite.level2": "Nivel 2",
  "pack.invite.level2Sub": "sus traídos",
  "pack.invite.viewNetworkAria": "Ver tu red — próximamente",
  "pack.invite.viewNetwork": "Ver tu red · pronto",
  "pack.invite.generatingLink": "Generando tu enlace…",
  "pack.invite.copyLinkAria": "Copiar enlace de invitación",
  "pack.invite.shareLink": "Comparte tu enlace",
  "pack.invite.apostlesRewards": "Las recompensas para los mejores apóstoles se desbloquean a medida que crece la religión.",
  "pack.invite.transparency": "Transparencia",
  "pack.invite.whereEveryGoes": "¿Adónde va cada {price}?",
  "pack.invite.tapBlock": "Toca un bloque para ver adónde va.",
  "pack.invite.yourLine": "Tu línea",
  "pack.invite.lineIntro": "Trae a un amante de los perros — y gana con todos los que ellos traigan después.",
  "pack.invite.nodeYou": "Tú",
  "pack.invite.nodeFriend": "Amigo",
  "pack.invite.nodeTheirFriend": "Su amigo",
  "pack.invite.brings": "trae",
  "pack.invite.lineExample": "Traes a <strong style=\"color: #7FA8FF\">Mia</strong> → ganas <strong style=\"color: #7FA8FF\">+20 BONES</strong>. Mia trae a <strong style=\"color: #E8836F\">Jakub</strong> → ganas <strong style=\"color: #E8836F\">+10</strong> más. Tu línea sigue pagándote — pata a pata.",
  "pack.invite.bonesValue": "10 BONES = €1 — gástalos dentro de DOGYPT.",
  "pack.steps.eyebrow": "Tu Perfil",
  "pack.steps.title": "Primeros Pasos",
  "pack.steps.rewardComplete": "Primeros Pasos completados — el próximo capítulo de la app llega pronto.",
  "pack.steps.rewardPending": "Completa todos los Primeros Pasos = <strong style=\"font-weight:800\">+10 ☥ de Devoción</strong> para tu perfil.",
  "pack.constitution.coverAlt": "DOGMA — la Constitución Dogyptian",
  "pack.constitution.readCta": "Lee el DOGMA",
  "pack.constitution.description": "El fundamento de toda la fe — todo Dogyptian debería leerlo. La filosofía, la lógica y cómo funciona la devoción comienzan aquí.",
  "pack.build.badge": "Trabajo en curso",
  "pack.build.heading": "Gracias por tu paciencia",
  "pack.build.body": "Todavía lo está construyendo un humano y sus agentes de AI. Cada error o idea ayuda.",
  "pack.build.thanks": "Recibido — gracias. Leemos cada palabra.",
  "pack.build.placeholder": "Un error o una idea… para errores, añade tu dispositivo y navegador.",
  "pack.build.previewAlt": "vista previa del adjunto",
  "pack.build.removePhoto": "Quitar foto",
  "pack.build.attach": "Adjunta una foto como prueba",
  "pack.build.error": "Algo salió mal. Inténtalo de nuevo.",
  "pack.build.uploading": "Subiendo…",
  "pack.build.sending": "Enviando…",
  "pack.build.send": "Enviar comentario",
  "pack.build.councilPrompt": "¿Quieres ayudar a darle forma?",
  "pack.build.councilCta": "Únete al Consejo",
  "pack.settings.section.account": "Cuenta",
  "pack.settings.field.email": "Correo electrónico",
  "pack.settings.field.password": "Contraseña",
  "pack.settings.password.setChange": "Crear / Cambiar",
  "pack.settings.field.language": "Idioma",
  "pack.settings.badge.lockedV0": "Bloqueado v0",
  "pack.settings.field.notifications": "Notificaciones",
  "pack.settings.badge.comingSoon": "Próximamente",
  "pack.settings.field.signOut": "Cerrar sesión",
  "pack.settings.signOut.button": "Cerrar sesión",
  "pack.settings.modal.title": "Contraseña",
  "pack.settings.modal.close": "Cerrar",
  "pack.settings.modal.descWelcome": "Termina tu cuenta — crea una contraseña para iniciar sesión cuando quieras sin el enlace por correo.",
  "pack.settings.modal.desc": "Crea o cambia tu contraseña para iniciar sesión con correo + contraseña.",
  "pack.settings.modal.newPasswordPlaceholder": "Nueva contraseña (mín. 8 caracteres)",
  "pack.settings.modal.confirmPasswordPlaceholder": "Confirmar contraseña",
  "pack.settings.modal.submit": "Crear contraseña",
  "pack.settings.error.minLength": "La contraseña debe tener al menos 8 caracteres.",
  "pack.settings.error.noMatch": "Las contraseñas no coinciden.",
  "pack.settings.error.generic": "No se pudo crear la contraseña.",
  "pack.settings.toast.title": "Contraseña creada",
  "pack.settings.toast.description": "Ahora puedes iniciar sesión con correo + contraseña.",
  "pack.dog.shield.parasites": "Parásitos",
  "pack.dog.shield.parasites.note": "Próxima dosis antiparasitaria y recordatorios.",
  "pack.dog.shield.vaccine": "Vacunación",
  "pack.dog.shield.vaccine.note": "Ventana de refuerzo y el historial completo de vacunación.",
  "pack.dog.shield.immunity": "Inmunidad",
  "pack.dog.shield.immunity.note": "Preparación inmunitaria general.",
  "pack.dog.shield.joints": "Cuidado articular",
  "pack.dog.shield.joints.note": "Suplementos de apoyo articular y su horario.",
  "pack.dog.shield.comingSoon": "{label} — próximamente",
  "pack.dog.toast.logFailed": "No se pudo registrar — inténtalo de nuevo",
  "pack.dog.toast.saved": "Guardado",
  "pack.dog.toast.couldNotSave": "No se pudo guardar",
  "pack.dog.toast.unknownError": "Error desconocido",
  "pack.dog.toast.messageSaved": "Mensaje guardado",
  "pack.dog.toast.messageSaved.desc": "Visible en tu tarjeta del WALL.",
  "pack.dog.toast.photoAdded": "Foto añadida",
  "pack.dog.toast.uploadFailed": "Error al subir",
  "pack.dog.toast.couldNotRemove": "No se pudo quitar",
  "pack.dog.toast.photoUpdated": "Foto actualizada",
  "pack.dog.toast.photoUpdated.desc": "Actualización del Wall y el certificado — próximamente.",
  "pack.dog.toast.certReady": "Certificado listo",
  "pack.dog.toast.certReady.desc": "Tus PDFs se han generado.",
  "pack.dog.toast.couldNotGenerate": "No se pudieron generar los PDFs",
  "pack.dog.toast.emailResent": "Correo reenviado",
  "pack.dog.toast.emailResent.desc": "Revisa tu bandeja de entrada en un momento.",
  "pack.dog.toast.couldNotResend": "No se pudo reenviar",
  "pack.dog.toast.comingSoon": "Próximamente",
  "pack.dog.loading": "CARGANDO",
  "pack.dog.unnamed": "Sin nombre",
  "pack.dog.viewOnWall": "Ver en el Wall {certNumber}",
  "pack.dog.passport.label": "El pasaporte de tu perro — una base de datos global. Próximamente.",
  "pack.dog.lost.label": "Perro perdido — declara una búsqueda, alerta al Pack. Próximamente.",
  "pack.dog.profileDocs": "Perfil y documentos",
  "pack.dog.changePhoto": "Cambiar foto",
  "pack.dog.noPhoto": "SIN FOTO",
  "pack.dog.livingBestLife": "Viviendo mi mejor vida",
  "pack.dog.birthdayUnknown": "Cumpleaños desconocido.",
  "pack.dog.backToProfile": "Volver al perfil",
  ...
  "pack.dog.wallPlaceholder": "Unas palabras que aparecen en tu tarjeta del WALL — un homenaje, un recuerdo, un saludo al Pack.",
  "pack.dog.saving": "Guardando",
  "pack.dog.save": "Guardar",
  "pack.dog.prayers.title": "Qué momento tan maravilloso para estar vivo.",
  "pack.dog.prayers.subtitle": "Las oraciones de hoy — pequeños actos de devoción a {dogName}.",
  "pack.dog.prayer.presence.title": "Oración de Presencia",
  "pack.dog.prayer.presence.hint": "10 minutos de atención plena — jugar, entrenar, simplemente estar. Sin móvil. Esta es la Oración de Presencia.",
  "pack.dog.prayer.walk.title": "Paseo",
  "pack.dog.prayer.walk.hint": "Desliza cuánto paseaste. Menos de una hora da 0,5 — luego 1 punto por hora, hasta 5 por una jornada de todo el día.",
  "pack.dog.walk.day": "Día",
  "pack.dog.prayer.ritual.title": "Ritual Abierto",
  "pack.dog.prayer.ritual.hint": "Añade tus propios actos de devoción — elige entre más rituales o crea uno personalizado.",
  "pack.dog.prayer.ritual.toastDesc": "Más rituales — y los tuyos personalizados — están en camino.",
  "pack.dog.choose": "Elegir",
  "pack.dog.devotion.logged": "Registrado hoy ✓ +{points} ☥",
  "pack.dog.devotion.today": "{points} de Devoción hoy",
  "pack.dog.submit": "Enviar",
  "pack.dog.lockedForToday": "Bloqueado por hoy · se reinicia mañana",
  "pack.dog.addsToStats": "Suma a tus estadísticas",
  "pack.dog.confirm.title": "¿Registrar las oraciones de hoy?",
  "pack.dog.confirm.body": "Esto es definitivo — la devoción de hoy no se puede cambiar.",
  "pack.dog.cancel": "Cancelar",
  "pack.dog.confirm.cta": "Registrar oraciones",
  "pack.dog.tile.health": "Salud",
  "pack.dog.tile.health.sub": "Vacunas · Veterinario · Comida",
  "pack.dog.tile.training": "Entrenamiento",
  "pack.dog.tile.training.sub": "Comandos · Insignias",
  "pack.dog.tile.journal": "Diario",
  "pack.dog.tile.journal.sub": "Historias · Fotos",
  "pack.dog.health.tagline": "Todo el historial de salud en un solo lugar — nada perdido, nada que falte.",
  "pack.dog.overview": "Resumen",
  "pack.dog.shareVet.toastDesc": "Comparte un perfil de salud de solo lectura con tu veterinario.",
  "pack.dog.shareWithVet": "Compartir con el veterinario",
  "pack.dog.fact.breed": "Raza",
  "pack.dog.fact.born": "Nacimiento",
  ...
  "pack.dog.fact.conditions": "Afecciones",
  "pack.dog.fact.medication": "Medicación",
  "pack.dog.test.personality": "Personalidad",
  "pack.dog.makeTest": "Hacer test",
  "pack.dog.test.personality.sub": "Elementos del TCM — fuego, metal, madera…",
  "pack.dog.test.personality.toastTitle": "Test de personalidad — próximamente",
  "pack.dog.test.personality.toastDesc": "Un breve cuestionario sitúa a tu perro en los cinco elementos.",
  "pack.dog.test.identity": "Identidad",
  "pack.dog.test.identity.sub": "Descubre {poss} tipo de carácter",
  "pack.dog.test.identity.toastTitle": "Test de identidad — próximamente",
  "pack.dog.test.identity.toastDesc": "Responde unas preguntas para situar {poss} tipo de carácter.",
  "pack.dog.vetCentre.title": "Centro veterinario",
  "pack.dog.vetCentre.desc": "Vacunaciones y visitas — previstas y pasadas — en una sola línea de tiempo que puedes compartir con cualquier veterinario.",
  "pack.dog.foodProtocol.title": "Protocolo de comida",
  "pack.dog.foodProtocol.desc": "Marca, porciones y alergias — la dieta en la que todo el Pack puede confiar.",
  "pack.dog.health.vision.title": "Protocolo de Salud por AI + una red veterinaria de confianza",
  "pack.dog.health.vision.body": "Un plan de longevidad para tu perro, impulsado por AI — y una red de primeros auxilios de veterinarios por toda la nación. El sentido de tener un millón de Dogyptians.",
  "pack.dog.training.tagline": "Cada comando aprendido, cada prueba ganada — anotado.",
  "pack.dog.training.commands": "Comandos",
  "pack.dog.training.commands.desc": "Sentado, quieto, llamada, junto… ve marcándolos a medida que {subj} domina cada uno.",
  "pack.dog.training.badges": "Insignias sagradas",
  "pack.dog.training.badges.desc": "Exposiciones, carreras, pruebas de obediencia, países visitados — ganados, nunca comprados.",
  "pack.dog.training.obedience": "Obediencia",
  "pack.dog.training.agility": "Agility",
  "pack.dog.soon": "Pronto",
  "pack.dog.training.vision.title": "Las insignias alimentan tu Devoción",
  "pack.dog.training.vision.body": "Las pruebas y los hitos se convierten en insignias sagradas en tu perfil — y en Devoción dentro del Pack. El canon se está escribiendo.",
  "pack.dog.journal.tagline": "Cada historia, cada foto — toda {poss} vida, conservada.",
  "pack.dog.instantStory": "Historia Instantánea",
  "pack.dog.instantStory.body": "Solo cuenta el momento — una nota de voz rápida que se registra bajo la fecha de hoy y se convierte en texto, quizás algún día una página de {poss} libro. Añade unas fotos y el día queda guardado para siempre.",
  "pack.dog.instantStory.toastTitle": "Historia Instantánea — próximamente",
  "pack.dog.instantStory.toastDesc": "Graba una nota de voz y se registra bajo la fecha de hoy.",
  "pack.dog.recordStory": "Grabar una historia",
  "pack.dog.addPhotos": "Añadir fotos",
  "pack.dog.addPhotos.toastDesc": "Adjunta fotos al momento.",
  "pack.dog.storyEarnsDevotion": "Cada historia gana Devoción.",
  "pack.dog.storyArchive": "Archivo de historias",
  "pack.dog.storyArchive.empty": "Aquí vivirán {poss} historias — las más recientes primero, cada nota de voz y foto por fecha.",
  "pack.dog.photoAlbum": "Álbum de fotos",
  "pack.dog.addPhoto": "Añadir foto",
  "pack.dog.noPhotosYet": "Aún no hay fotos.",
  "pack.dog.stats": "ESTADÍSTICAS",
  "pack.dog.stats.subtitle": "Cada día que registras brilla — un calendario vivo de tu devoción.",
  "pack.dog.comingSoon": "Próximamente",
  "pack.dog.resendEmail": "Reenviar correo",
  "pack.dog.showAgeDetail": "Mostrar detalle de edad",
  "pack.dog.daysCount": "{days} días",
  "pack.dog.ageDetail": "{years}a {months}m {days}d · ≈ {humanYears} años humanos",
  "pack.dog.legend": "Leyenda",
  "pack.dog.legend.trip": "Excursión",
  "pack.dog.legend.trip.desc": "Un largo día en la naturaleza",
  "pack.dog.legend.walk": "Paseo",
  "pack.dog.legend.walk.desc": "Un buen paseo diario",
  "pack.dog.legend.stroll": "Vuelta",
  "pack.dog.legend.stroll.desc": "Una vuelta rápida a la manzana",
  "pack.dog.legend.vet": "Veterinario",
  "pack.dog.legend.vet.desc": "Salud y revisiones",
  "pack.dog.legend.birthday": "Cumpleaños",
  "pack.dog.legend.birthday.desc": "El de verdad",
  "pack.dog.legend.humanYear": "Año humano",
  "pack.dog.legend.humanYear.desc": "1 de 7 — planea algo",
  "pack.dog.addActivity": "Añadir actividad",
  "pack.dog.addActivity.sub": "Nombre, color e icono — próximamente",
  "pack.dog.health.healthy": "Sano",
  "pack.dog.health.injury": "Lesión",
  "pack.dog.health.gastro": "Gastro",
  "pack.dog.health.allergy": "Alergia",
  "pack.dog.health.other": "Otro",
  "pack.dog.health.visionNote": "Algún día, marcar a tu perro como enfermo alertará a los sanadores de DOGYPT cercanos a ti — y nuestra AI se pondrá en contacto para ayudar. Una red global de primeros auxilios para perros.",
  "pack.dog.visionNotLive": "Visión · aún no activa",
  "pack.dog.stillAlive": "Sigue vivo",
  "pack.dog.stillAliveTooltip": "Sigue vivo, listo para divertirse",
  "pack.dog.live": "En vivo",
  "pack.dog.dailyPrayers": "Oraciones Diarias",
  "pack.dog.dailyPrayers.body": "Los actos diarios de devoción a {dogName} — presencia, el paseo y el ritual — están en camino.",
  "pack.dog.main": "PRINCIPAL",
  "pack.dog.removePhoto": "Quitar foto",
  "pack.dog.officialRecord": "El registro oficial",
  "pack.dog.notFound.title": "No encontrado",
  "pack.dog.notFound.body": "Este Heroglyph no es tuyo o ya no existe.",
  "pack.dog.backToPack": "Volver al Pack",
  "pack.dog.error.body": "Algo salió mal al cargar este Heroglyph.",
