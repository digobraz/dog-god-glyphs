...
export const fra: Partial<Dict> = {
  ...
  "pack.page.steps.forge": "Forgez votre premier Heroglyph",
  "pack.page.steps.photo": "Ajoutez votre photo",
  "pack.page.steps.extras": "Ajoutez d'autres photos de votre chien",
  "pack.page.steps.vote": "Votez dans Façonner",
  "pack.page.steps.constitution": "Feuilletez la Constitution",
  "pack.page.steps.invite": "Invitez votre premier amoureux des chiens",
  "pack.nav.loading": "CHARGEMENT…",
  "pack.nav.home": "Accueil",
  "pack.nav.portal": "Portail",
  "pack.nav.profile": "Profil",
  "pack.nav.yourAvatar": "Votre avatar",
  "pack.nav.jumpToNationStats": "Aller aux stats de la Nation",
  "pack.nav.bonesCount": "{count} BONES",
  "pack.nav.dog": "Chien",
  "pack.hero.toast.photoUpdated": "Photo mise à jour",
  "pack.hero.toast.uploadFailed": "Échec de l'envoi",
  "pack.hero.toast.unknownError": "Erreur inconnue",
  "pack.hero.toast.nameUpdated": "Nom mis à jour",
  "pack.hero.toast.couldNotSave": "Enregistrement impossible",
  "pack.hero.editAvatar": "Modifier l'avatar",
  "pack.hero.welcomeBack": "Bon retour parmi nous",
  "pack.hero.namePlaceholder": "Votre nom",
  "pack.hero.saveName": "Enregistrer le nom",
  "pack.hero.editName": "Modifier le nom",
  "pack.hero.statusPawtner": "Pawtner",
  "pack.hero.bonesAria": "{bones} BONES",
  "pack.hero.devotionAria": "Dévotion {devotion}, niveau {index} {name}",
  "pack.hero.devotionTip": "Dévotion",
  "pack.hero.toNext": "{count} ☥ pour {name}",
  "pack.hero.maxDevotion": "Dévotion maximale atteinte",
  "pack.tree.title": "Ma Pack",
  "pack.tree.unnamed": "Sans nom",
  "pack.tree.profileLink.title": "Ouvrir le profil du chien — certificats, PDFs, photos",
  "pack.tree.profileLink.ariaLabel": "Ouvrir le profil du chien",
  "pack.tree.noPhoto": "AUCUNE PHOTO",
  "pack.tree.heroglyphAlt": "Heroglyph de {name}",
  "pack.tree.empty": "Pas encore de Heroglyphs",
  "pack.tree.addDog": "Ajouter un chien",
  "pack.tree.addHumanMember": "Ajouter un membre humain",
  "pack.tree.comingSoonTooltip": "Bientôt disponible — invitez un membre humain",
  ...
  "pack.globe.milestone.founders": "Les Fondateurs",
  "pack.globe.milestone.pack": "La Pack",
  "pack.globe.milestone.nation": "La Nation",
  "pack.globe.milestone.dynasty": "La Dynastie",
  "pack.globe.canvasLabel": "La Pack à travers le monde",
  "pack.globe.roadToMillion": "Le chemin vers le million",
  "pack.globe.milestoneDot": "Jalon {num}",
  "pack.globe.prevMilestone": "Jalon précédent",
  "pack.globe.nextMilestone": "Jalon suivant",
  "pack.globe.achieved": "ATTEINT",
  "pack.globe.dogyptiansWorldwide": "Dogyptians<br />à travers le monde",
  "pack.globe.nation": "nation",
  "pack.globe.topCountries": "Top pays",
  "pack.globe.topBreeds": "Top races",
  "pack.survey.heading": "Façonnez l'app",
  "pack.survey.subheading": "Que devrions-nous construire en premier ?",
  "pack.survey.toggle.vote": "Voter",
  "pack.survey.toggle.results": "Résultats",
  "pack.survey.feature.mobileApp.title": "App mobile",
  "pack.survey.feature.mobileApp.blurb": "Réseau social, carte des lieux dog-friendly et messagerie de la Pack — la Pack dans votre poche.",
  "pack.survey.feature.healthAi.title": "Protocole Santé par IA",
  "pack.survey.feature.healthAi.blurb": "Un plan de longévité pour votre chien, propulsé par l'AI — et un réseau de vétérinaires de confiance.",
  "pack.survey.feature.merch.title": "Boutique",
  "pack.survey.feature.merch.blurb": "Tirages Heroglyph, colliers, livres et accessoires sacrés.",
  "pack.survey.voted": "Voté",
  "pack.survey.voteForThis": "Je vote pour ça",
  "pack.survey.dot.goTo": "Aller à {name}",
  "pack.survey.footer.collecting": "On collecte jusqu'au {date} — puis on construit.",
  "pack.survey.footer.votes": "{count} votes",
  "pack.survey.nav.previous": "Précédent",
  "pack.survey.nav.next": "Suivant",
  "pack.invite.copied": "Lien copié",
  "pack.invite.copiedDesc": "Partagez-le et faites grandir la Pack.",
  "pack.invite.copyError": "Copie impossible",
  "pack.invite.shareText": "Rejoignez la Pack. Devenez Dogyptian.",
  "pack.invite.close": "Fermer",
  "pack.invite.howLineWorks": "Comment fonctionne votre lignée",
  "pack.invite.whereEuroGoes": "Où va chaque euro",
  "pack.invite.hekthorAlt": "Hekthor — fondateur n°1",
  "pack.invite.growHeading": "Faites grandir la Pack.",
  "pack.invite.growBody": "Chaque Dogyptian que vous amenez vous rapporte des <strong style=\"color: hsl(45 95% 88%)\">BONES</strong> — tout comme chaque personne qu'il amène à son tour. Patte après patte, nous atteindrons le million.",
  "pack.invite.level1": "Niveau 1",
  "pack.invite.level1Sub": "directs",
  "pack.invite.level2": "Niveau 2",
  "pack.invite.level2Sub": "leurs apports",
  "pack.invite.viewNetworkAria": "Voir votre réseau — bientôt disponible",
  "pack.invite.viewNetwork": "Voir votre réseau · bientôt",
  "pack.invite.generatingLink": "Génération de votre lien…",
  "pack.invite.copyLinkAria": "Copier le lien d'invitation",
  "pack.invite.shareLink": "Partager votre lien",
  "pack.invite.apostlesRewards": "Les récompenses des meilleurs apôtres se débloquent à mesure que la religion grandit.",
  "pack.invite.transparency": "Transparence",
  "pack.invite.whereEveryGoes": "Où va chaque {price} ?",
  "pack.invite.tapBlock": "Touchez un bloc pour voir où ça va.",
  "pack.invite.yourLine": "Votre lignée",
  "pack.invite.lineIntro": "Amenez un amoureux des chiens — et gagnez grâce à tous ceux qu'il amènera ensuite.",
  "pack.invite.nodeYou": "Vous",
  "pack.invite.nodeFriend": "Ami",
  "pack.invite.nodeTheirFriend": "Son ami",
  "pack.invite.brings": "amène",
  "pack.invite.lineExample": "Vous amenez <strong style=\"color: #7FA8FF\">Mia</strong> → vous gagnez <strong style=\"color: #7FA8FF\">+20 BONES</strong>. Mia amène <strong style=\"color: #E8836F\">Jakub</strong> → vous gagnez <strong style=\"color: #E8836F\">+10</strong> de plus. Votre lignée continue de vous rapporter — patte après patte.",
  "pack.invite.bonesValue": "10 BONES = €1 — dépensez-les dans DOGYPT.",
  "pack.steps.eyebrow": "Votre profil",
  "pack.steps.title": "Premiers pas",
  "pack.steps.rewardComplete": "Premiers pas terminés — le prochain chapitre de l'app arrive bientôt.",
  "pack.steps.rewardPending": "Terminez tous les Premiers pas = <strong style=\"font-weight:800\">+10 ☥ de Dévotion</strong> sur votre profil.",
  "pack.constitution.coverAlt": "DOGMA — la Constitution Dogyptian",
  "pack.constitution.readCta": "Lire le DOGMA",
  "pack.constitution.description": "Le fondement de toute la foi — chaque Dogyptian devrait le lire. La philosophie, la logique et le fonctionnement de la dévotion commencent tous ici.",
  "pack.build.badge": "Travail en cours",
  "pack.build.heading": "Merci pour votre patience",
  "pack.build.body": "Encore en construction par un humain et ses agents AI. Chaque bug ou idée aide.",
  "pack.build.thanks": "C'est noté — merci. Nous lisons chaque mot.",
  "pack.build.placeholder": "Un bug ou une idée… pour les bugs, indiquez votre appareil et navigateur.",
  "pack.build.previewAlt": "aperçu de la pièce jointe",
  "pack.build.removePhoto": "Retirer la photo",
  "pack.build.attach": "Joindre une photo comme preuve",
  "pack.build.error": "Une erreur s'est produite. Réessayez.",
  "pack.build.uploading": "Envoi…",
  "pack.build.sending": "Envoi…",
  "pack.build.send": "Envoyer un retour",
  "pack.build.councilPrompt": "Envie d'aider à la façonner ?",
  "pack.build.councilCta": "Rejoindre le Conseil",
  "pack.settings.section.account": "Compte",
  "pack.settings.field.email": "E-mail",
  "pack.settings.field.password": "Mot de passe",
  "pack.settings.password.setChange": "Définir / Changer",
  "pack.settings.field.language": "Langue",
  "pack.settings.badge.lockedV0": "Verrouillé v0",
  "pack.settings.field.notifications": "Notifications",
  "pack.settings.badge.comingSoon": "Bientôt disponible",
  "pack.settings.field.signOut": "Se déconnecter",
  "pack.settings.signOut.button": "Se déconnecter",
  "pack.settings.modal.title": "Mot de passe",
  "pack.settings.modal.close": "Fermer",
  "pack.settings.modal.descWelcome": "Finalisez votre compte — définissez un mot de passe pour vous connecter à tout moment sans le lien e-mail.",
  "pack.settings.modal.desc": "Définissez ou changez votre mot de passe pour la connexion e-mail + mot de passe.",
  "pack.settings.modal.newPasswordPlaceholder": "Nouveau mot de passe (min. 8 caractères)",
  "pack.settings.modal.confirmPasswordPlaceholder": "Confirmer le mot de passe",
  "pack.settings.modal.submit": "Définir le mot de passe",
  "pack.settings.error.minLength": "Le mot de passe doit comporter au moins 8 caractères.",
  "pack.settings.error.noMatch": "Les mots de passe ne correspondent pas.",
  "pack.settings.error.generic": "Impossible de définir le mot de passe.",
  "pack.settings.toast.title": "Mot de passe défini",
  "pack.settings.toast.description": "Vous pouvez désormais vous connecter avec e-mail + mot de passe.",
  "pack.dog.shield.parasites": "Parasites",
  "pack.dog.shield.parasites.note": "Prochaine dose antiparasitaire et rappels.",
  "pack.dog.shield.vaccine": "Vaccination",
  "pack.dog.shield.vaccine.note": "Fenêtre de rappel et carnet de vaccination complet.",
  "pack.dog.shield.immunity": "Immunité",
  "pack.dog.shield.immunity.note": "État de préparation immunitaire global.",
  "pack.dog.shield.joints": "Soin des articulations",
  "pack.dog.shield.joints.note": "Compléments pour les articulations et calendrier.",
  "pack.dog.shield.comingSoon": "{label} — bientôt disponible",
  "pack.dog.toast.logFailed": "Enregistrement impossible — réessayez",
  "pack.dog.toast.saved": "Enregistré",
  "pack.dog.toast.couldNotSave": "Enregistrement impossible",
  "pack.dog.toast.unknownError": "Erreur inconnue",
  "pack.dog.toast.messageSaved": "Message enregistré",
  "pack.dog.toast.messageSaved.desc": "Visible sur votre carte WALL.",
  "pack.dog.toast.photoAdded": "Photo ajoutée",
  "pack.dog.toast.uploadFailed": "Échec de l'envoi",
  "pack.dog.toast.couldNotRemove": "Suppression impossible",
  "pack.dog.toast.photoUpdated": "Photo mise à jour",
  "pack.dog.toast.photoUpdated.desc": "Mise à jour du Wall et du certificat — bientôt disponible.",
  "pack.dog.toast.certReady": "Certificat prêt",
  "pack.dog.toast.certReady.desc": "Vos PDFs ont été générés.",
  "pack.dog.toast.couldNotGenerate": "Impossible de générer les PDFs",
  "pack.dog.toast.emailResent": "E-mail renvoyé",
  "pack.dog.toast.emailResent.desc": "Vérifiez votre boîte de réception dans un instant.",
  "pack.dog.toast.couldNotResend": "Renvoi impossible",
  "pack.dog.toast.comingSoon": "Bientôt disponible",
  "pack.dog.loading": "CHARGEMENT",
  "pack.dog.unnamed": "Sans nom",
  "pack.dog.viewOnWall": "Voir sur le Wall {certNumber}",
  "pack.dog.passport.label": "Le passeport de votre chien — une base de données mondiale. Bientôt disponible.",
  "pack.dog.lost.label": "Chien perdu — lancez une recherche, alertez la Pack. Bientôt disponible.",
  "pack.dog.profileDocs": "Profil et documents",
  "pack.dog.changePhoto": "Changer la photo",
  "pack.dog.noPhoto": "AUCUNE PHOTO",
  "pack.dog.livingBestLife": "Je vis ma plus belle vie",
  "pack.dog.birthdayUnknown": "Date de naissance inconnue.",
  "pack.dog.backToProfile": "Retour au profil",
  "pack.dog.doc.certificate": "Certificat",
  "pack.dog.doc.vertical": "Vertical",
  "pack.dog.doc.horizontal": "Horizontal",
  "pack.dog.hideCert": "Masquer le certificat",
  "pack.dog.viewCert": "Voir le certificat",
  "pack.dog.generating": "Génération…",
  "pack.dog.regeneratePdfs": "Régénérer les PDFs",
  "pack.dog.generatePdfs": "Générer les PDFs",
  "pack.dog.wordOnWall": "Un mot sur le Wall",
  "pack.dog.wallPlaceholder": "Quelques mots affichés sur votre carte WALL — un hommage, un souvenir, un bonjour à la Pack.",
  "pack.dog.saving": "Enregistrement",
  "pack.dog.save": "Enregistrer",
  "pack.dog.prayers.title": "Quel merveilleux moment pour être en vie.",
  "pack.dog.prayers.subtitle": "Les prières du jour — de petits actes de dévotion envers {dogName}.",
  "pack.dog.prayer.presence.title": "Prière de Présence",
  "pack.dog.prayer.presence.hint": "10 minutes d'attention totale — jouer, dresser, simplement être. Sans téléphone. C'est la Prière de Présence.",
  "pack.dog.prayer.walk.title": "Promenade",
  "pack.dog.prayer.walk.hint": "Faites glisser la durée de votre promenade. Moins d'une heure rapporte 0,5 — puis 1 point par heure, jusqu'à 5 pour une virée d'une journée entière.",
  "pack.dog.walk.day": "Jour",
  "pack.dog.prayer.ritual.title": "Rituel libre",
  "pack.dog.prayer.ritual.hint": "Ajoutez vos propres actes de dévotion — choisissez parmi d'autres rituels ou créez le vôtre.",
  "pack.dog.prayer.ritual.toastDesc": "D'autres rituels — et les vôtres sur mesure — arrivent bientôt.",
  "pack.dog.choose": "Choisir",
  "pack.dog.devotion.logged": "Enregistré pour aujourd'hui ✓ +{points} ☥",
  "pack.dog.devotion.today": "{points} de Dévotion aujourd'hui",
  "pack.dog.submit": "Valider",
  "pack.dog.lockedForToday": "Verrouillé pour aujourd'hui · réinitialisé demain",
  "pack.dog.addsToStats": "S'ajoute à vos stats",
  "pack.dog.confirm.title": "Enregistrer les prières du jour ?",
  "pack.dog.confirm.body": "C'est définitif — la dévotion d'aujourd'hui ne peut plus être modifiée.",
  "pack.dog.cancel": "Annuler",
  "pack.dog.confirm.cta": "Enregistrer les prières",
  "pack.dog.tile.health": "Santé",
  "pack.dog.tile.health.sub": "Vaccins · Vétérinaire · Alimentation",
  "pack.dog.tile.training": "Dressage",
  "pack.dog.tile.training.sub": "Commandes · Badges",
  "pack.dog.tile.journal": "Journal",
  "pack.dog.tile.journal.sub": "Histoires · Photos",
  "pack.dog.health.tagline": "Tout le carnet de santé au même endroit — rien de perdu, rien d'oublié.",
  "pack.dog.overview": "Aperçu",
  "pack.dog.shareVet.toastDesc": "Partagez un profil de santé en lecture seule avec votre vétérinaire.",
  "pack.dog.shareWithVet": "Partager avec le vétérinaire",
  "pack.dog.fact.breed": "Race",
  "pack.dog.fact.born": "Né",
  "pack.dog.fact.weight": "Poids",
  "pack.dog.saveWeight": "Enregistrer le poids",
  "pack.dog.addWeight": "— Ajouter le poids",
  "pack.dog.fact.diet": "Régime",
  "pack.dog.addDiet": "Ajouter un régime…",
  "pack.dog.protection": "Protection",
  "pack.dog.preview": "Aperçu",
  "pack.dog.fact.allergies": "Allergies",
  "pack.dog.fact.conditions": "Affections",
  "pack.dog.fact.medication": "Médication",
  "pack.dog.test.personality": "Personnalité",
  "pack.dog.makeTest": "Faire le test",
  "pack.dog.test.personality.sub": "Éléments TCM — feu, métal, bois…",
  "pack.dog.test.personality.toastTitle": "Test de personnalité — bientôt disponible",
  "pack.dog.test.personality.toastDesc": "Un court quiz situe votre chien parmi les cinq éléments.",
  "pack.dog.test.identity": "Identité",
  "pack.dog.test.identity.sub": "Trouvez {poss} type de caractère",
  "pack.dog.test.identity.toastTitle": "Test d'identité — bientôt disponible",
  "pack.dog.test.identity.toastDesc": "Répondez à quelques questions pour situer {poss} type de caractère.",
  "pack.dog.vetCentre.title": "Centre vétérinaire",
  "pack.dog.vetCentre.desc": "Vaccinations et visites — prévues et passées — dans une seule chronologie que vous pouvez partager avec n'importe quel vétérinaire.",
  "pack.dog.foodProtocol.title": "Protocole alimentaire",
  "pack.dog.foodProtocol.desc": "Marque, portions et allergies — le régime auquel toute la Pack peut se fier.",
  "pack.dog.health.vision.title": "Protocole Santé par AI + un réseau de vétérinaires de confiance",
  "pack.dog.health.vision.body": "Un plan de longévité pour votre chien, propulsé par l'AI — et un réseau de premiers secours de vétérinaires à travers la nation. Tout l'intérêt d'un million de Dogyptians.",
  "pack.dog.training.tagline": "Chaque commande apprise, chaque épreuve remportée — consignée.",
  "pack.dog.training.commands": "Commandes",
  "pack.dog.training.commands.desc": "Assis, reste, rappel, au pied… cochez-les à mesure que {subj} les maîtrise.",
  "pack.dog.training.badges": "Badges sacrés",
  "pack.dog.training.badges.desc": "Expositions, courses, épreuves d'obéissance, pays visités — gagnés, jamais achetés.",
  "pack.dog.training.obedience": "Obéissance",
  "pack.dog.training.agility": "Agility",
  "pack.dog.soon": "Bientôt",
  "pack.dog.training.vision.title": "Les badges nourrissent votre Dévotion",
  "pack.dog.training.vision.body": "Les épreuves et les jalons deviennent des badges sacrés sur votre profil — et de la Dévotion dans la Pack. Le canon est en train de s'écrire.",
  "pack.dog.journal.tagline": "Chaque histoire, chaque photo — toute {poss} vie, gardée.",
  "pack.dog.instantStory": "Histoire instantanée",
  "pack.dog.instantStory.body": "Racontez simplement l'instant — un rapide mémo vocal enregistré à la date du jour qui se transforme en texte, un jour peut-être une page de {poss} livre. Ajoutez quelques photos et la journée est sauvegardée pour toujours.",
  "pack.dog.instantStory.toastTitle": "Histoire instantanée — bientôt disponible",
  "pack.dog.instantStory.toastDesc": "Enregistrez un mémo vocal et il se consigne à la date du jour.",
  "pack.dog.recordStory": "Enregistrer une histoire",
  "pack.dog.addPhotos": "Ajouter des photos",
  "pack.dog.addPhotos.toastDesc": "Joignez des photos à l'instant.",
  "pack.dog.storyEarnsDevotion": "Chaque histoire rapporte de la Dévotion.",
  "pack.dog.storyArchive": "Archive des histoires",
  "pack.dog.storyArchive.empty": "{poss} histoires vivront ici — les plus récentes d'abord, chaque mémo vocal et photo par date.",
  ...
  "pack.dog.stats.subtitle": "Chaque jour que vous consignez s'illumine — un calendrier vivant de votre dévotion.",
  "pack.dog.comingSoon": "Bientôt disponible",
  "pack.dog.resendEmail": "Renvoyer l'e-mail",
  "pack.dog.showAgeDetail": "Afficher le détail de l'âge",
  "pack.dog.daysCount": "{days} jours",
  "pack.dog.ageDetail": "{years} a {months} m {days} j · ≈ {humanYears} années humaines",
  "pack.dog.legend": "Légende",
  "pack.dog.legend.trip": "Excursion",
  "pack.dog.legend.trip.desc": "Une longue journée dans la nature",
  "pack.dog.legend.walk": "Promenade",
  "pack.dog.legend.walk.desc": "Une vraie promenade quotidienne",
  "pack.dog.legend.stroll": "Balade",
  "pack.dog.legend.stroll.desc": "Un petit tour du quartier",
  "pack.dog.legend.vet": "Vétérinaire",
  "pack.dog.legend.vet.desc": "Santé et contrôles",
  "pack.dog.legend.birthday": "Anniversaire",
  "pack.dog.legend.birthday.desc": "Le vrai",
  "pack.dog.legend.humanYear": "Année humaine",
  "pack.dog.legend.humanYear.desc": "1 sur 7 — prévoyez quelque chose",
  "pack.dog.addActivity": "Ajouter une activité",
  "pack.dog.addActivity.sub": "Nom, couleur et icône — bientôt disponible",
  "pack.dog.health.healthy": "En bonne santé",
  "pack.dog.health.injury": "Blessure",
  "pack.dog.health.gastro": "Gastro",
  "pack.dog.health.allergy": "Allergie",
  "pack.dog.health.other": "Autre",
  "pack.dog.health.visionNote": "Un jour, signaler votre chien souffrant alertera les guérisseurs DOGYPT près de chez vous — et notre AI vous contactera pour vous aider. Un réseau mondial de premiers secours pour les chiens.",
  "pack.dog.visionNotLive": "Vision · pas encore active",
  "pack.dog.stillAlive": "Toujours en vie",
  "pack.dog.stillAliveTooltip": "Toujours en vie, prêt à s'amuser",
  "pack.dog.live": "En vie",
  "pack.dog.dailyPrayers": "Prières quotidiennes",
  "pack.dog.dailyPrayers.body": "Les actes quotidiens de dévotion envers {dogName} — la présence, la promenade et le rituel — arrivent bientôt.",
  "pack.dog.main": "PRINCIPAL",
  "pack.dog.removePhoto": "Retirer la photo",
  "pack.dog.officialRecord": "Le registre officiel",
  "pack.dog.notFound.title": "Introuvable",
  "pack.dog.notFound.body": "Ce Heroglyph n'est pas le vôtre ou n'existe plus.",
  "pack.dog.backToPack": "Retour à la Pack",
  "pack.dog.error.body": "Une erreur s'est produite lors du chargement de ce Heroglyph.",
