...
export const en = {
  ...
  // ── /pack — page (onboarding step labels) ──
  'pack.page.steps.forge': 'Forge your first heroglyph',
  'pack.page.steps.photo': 'Add your photo',
  'pack.page.steps.extras': 'Add extra photos of your dog',
  'pack.page.steps.vote': 'Cast your vote in Shape',
  'pack.page.steps.constitution': 'Flip through the Constitution',
  'pack.page.steps.invite': 'Invite your first dog lover',

  // ── /pack — nav / chrome (PackLayout) ──
  'pack.nav.loading': 'LOADING…',
  'pack.nav.home': 'Home',
  'pack.nav.portal': 'Portal',
  'pack.nav.profile': 'Profile',
  'pack.nav.yourAvatar': 'Your avatar',
  'pack.nav.jumpToNationStats': 'Jump to Nation stats',
  'pack.nav.bonesCount': '{count} BONES',
  'pack.nav.dog': 'Dog',

  // ── /pack — HeroCard (owner card) ──
  'pack.hero.toast.photoUpdated': 'Photo updated',
  'pack.hero.toast.uploadFailed': 'Upload failed',
  'pack.hero.toast.unknownError': 'Unknown error',
  'pack.hero.toast.nameUpdated': 'Name updated',
  'pack.hero.toast.couldNotSave': 'Could not save',
  'pack.hero.editAvatar': 'Edit avatar',
  'pack.hero.welcomeBack': 'Welcome back',
  'pack.hero.namePlaceholder': 'Your name',
  'pack.hero.saveName': 'Save name',
  'pack.hero.editName': 'Edit name',
  'pack.hero.statusPawtner': 'Pawtner',
  'pack.hero.bonesAria': '{bones} BONES',
  'pack.hero.devotionAria': 'Devotion {devotion}, level {index} {name}',
  'pack.hero.devotionTip': 'Devotion',
  'pack.hero.toNext': '{count} ☥ to {name}',
  'pack.hero.maxDevotion': 'Highest devotion reached',

  // ── /pack — PackTree ──
  'pack.tree.title': 'My Pack',
  'pack.tree.unnamed': 'Unnamed',
  'pack.tree.profileLink.title': 'Open dog profile — certificates, PDFs, photos',
  'pack.tree.profileLink.ariaLabel': 'Open dog profile',
  'pack.tree.noPhoto': 'NO PHOTO',
  'pack.tree.heroglyphAlt': '{name} heroglyph',
  'pack.tree.empty': 'No heroglyphs yet',
  'pack.tree.addDog': 'Add dog',
  'pack.tree.addHumanMember': 'Add human member',
  'pack.tree.comingSoonTooltip': 'Coming soon — invite one human member',
  ...
  // ── /pack — GlobePulse (worldwide counter + milestones) ──
  'pack.globe.milestone.founders': 'The Founders',
  'pack.globe.milestone.pack': 'The Pack',
  'pack.globe.milestone.nation': 'The Nation',
  'pack.globe.milestone.dynasty': 'The Dynasty',
  'pack.globe.canvasLabel': 'The pack worldwide',
  'pack.globe.roadToMillion': 'The road to a million',
  'pack.globe.milestoneDot': 'Milestone {num}',
  'pack.globe.prevMilestone': 'Previous milestone',
  'pack.globe.nextMilestone': 'Next milestone',
  'pack.globe.achieved': 'ACHIEVED',
  'pack.globe.dogyptiansWorldwide': 'Dogyptians<br />worldwide',
  'pack.globe.nation': 'nation',
  'pack.globe.topCountries': 'Top countries',
  'pack.globe.topBreeds': 'Top breeds',

  // ── /pack — FeatureSurveyCard (Shape the app) ──
  'pack.survey.heading': 'Shape the app',
  'pack.survey.subheading': 'What should we build first?',
  'pack.survey.toggle.vote': 'Vote',
  'pack.survey.toggle.results': 'Results',
  'pack.survey.feature.mobileApp.title': 'Mobile App',
  'pack.survey.feature.mobileApp.blurb': 'Social network, dog-friendly map & pack messaging — the pack in your pocket.',
  'pack.survey.feature.healthAi.title': 'Health Protocol by AI',
  'pack.survey.feature.healthAi.blurb': 'A longevity blueprint for your dog, powered by AI — plus a trusted vet network.',
  'pack.survey.feature.merch.title': 'Merch',
  'pack.survey.feature.merch.blurb': 'Heroglyph prints, collars, books & sacred accessories.',
  'pack.survey.voted': 'Voted',
  'pack.survey.voteForThis': 'I vote for this',
  'pack.survey.dot.goTo': 'Go to {name}',
  'pack.survey.footer.collecting': 'Collecting until {date} — then we build.',
  'pack.survey.footer.votes': '{count} votes',
  'pack.survey.nav.previous': 'Previous',
  'pack.survey.nav.next': 'Next',

  // ── /pack — FounderInvite (affiliate / invite line) ──
  'pack.invite.copied': 'Link copied',
  'pack.invite.copiedDesc': 'Share it and grow the pack.',
  'pack.invite.copyError': 'Could not copy',
  'pack.invite.shareText': 'Join the pack. Become Dogyptian.',
  'pack.invite.close': 'Close',
  'pack.invite.howLineWorks': 'How your line works',
  'pack.invite.whereEuroGoes': 'Where every euro goes',
  'pack.invite.hekthorAlt': 'Hekthor — founder #1',
  'pack.invite.growHeading': 'Grow the pack.',
  'pack.invite.growBody':
    'Every Dogyptian you bring earns you <strong style="color: hsl(45 95% 88%)">BONES</strong> — and so does everyone they bring after. Paw to paw, we reach the million.',
  'pack.invite.level1': 'Level 1',
  'pack.invite.level1Sub': 'direct',
  'pack.invite.level2': 'Level 2',
  'pack.invite.level2Sub': 'their brings',
  'pack.invite.viewNetworkAria': 'View your network — coming soon',
  'pack.invite.viewNetwork': 'View your network · soon',
  'pack.invite.generatingLink': 'Generating your link…',
  'pack.invite.copyLinkAria': 'Copy invite link',
  'pack.invite.shareLink': 'Share your link',
  'pack.invite.apostlesRewards': 'Rewards for top apostles unlock as the religion grows.',
  'pack.invite.transparency': 'Transparency',
  'pack.invite.whereEveryGoes': 'Where every {price} goes?',
  'pack.invite.tapBlock': 'Tap a block to see where it goes.',
  'pack.invite.yourLine': 'Your line',
  'pack.invite.lineIntro': 'Bring a dog lover — and earn from everyone they bring after.',
  'pack.invite.nodeYou': 'You',
  'pack.invite.nodeFriend': 'Friend',
  'pack.invite.nodeTheirFriend': 'Their friend',
  'pack.invite.brings': 'brings',
  'pack.invite.lineExample':
    'You bring <strong style="color: #7FA8FF">Mia</strong> → you earn <strong style="color: #7FA8FF">+20 BONES</strong>. Mia brings <strong style="color: #E8836F">Jakub</strong> → you earn <strong style="color: #E8836F">+10</strong> more. Your line keeps paying you — paw to paw.',
  'pack.invite.bonesValue': '10 BONES = €1 — spend them inside DOGYPT.',

  // ── /pack — OnboardingProgress (First Steps) ──
  'pack.steps.eyebrow': 'Your Profile',
  'pack.steps.title': 'First Steps',
  'pack.steps.rewardComplete': 'First Steps complete — the next chapter of the app is coming soon.',
  'pack.steps.rewardPending': 'Complete all First Steps = <strong style="font-weight:800">+10 ☥ Devotion</strong> to your profile.',

  // ── /pack — ConstitutionCard ──
  'pack.constitution.coverAlt': 'DOGMA — the Dogyptian Constitution',
  'pack.constitution.readCta': 'Read the DOGMA',
  'pack.constitution.description': 'The foundation of the whole faith — every Dogyptian should read it. The philosophy, the logic, and how devotion works all begin here.',

  // ── /pack — BuildNotice (feedback) ──
  ...
  'pack.build.thanks': 'Got it — thank you. We read every word.',
  'pack.build.placeholder': 'A bug or an idea… for bugs, add your device & browser.',
  'pack.build.previewAlt': 'attachment preview',
  'pack.build.removePhoto': 'Remove photo',
  'pack.build.attach': 'Attach a photo as proof',
  'pack.build.error': 'Something went wrong. Try again.',
  'pack.build.uploading': 'Uploading…',
  'pack.build.sending': 'Sending…',
  'pack.build.send': 'Send feedback',
  'pack.build.councilPrompt': 'Want to help shape it?',
  'pack.build.councilCta': 'Join the Council',

  // ── /pack — PackSettings (account) ──
  'pack.settings.section.account': 'Account',
  'pack.settings.field.email': 'Email',
  'pack.settings.field.password': 'Password',
  'pack.settings.password.setChange': 'Set / Change',
  'pack.settings.field.language': 'Language',
  'pack.settings.badge.lockedV0': 'Locked v0',
  'pack.settings.field.notifications': 'Notifications',
  'pack.settings.badge.comingSoon': 'Coming soon',
  'pack.settings.field.signOut': 'Sign out',
  'pack.settings.signOut.button': 'Sign out',
  'pack.settings.modal.title': 'Password',
  'pack.settings.modal.close': 'Close',
  'pack.settings.modal.descWelcome': 'Finish your account — set a password to log in any time without the email link.',
  'pack.settings.modal.desc': 'Set or change your password for email + password login.',
  'pack.settings.modal.newPasswordPlaceholder': 'New password (min 8 characters)',
  'pack.settings.modal.confirmPasswordPlaceholder': 'Confirm password',
  'pack.settings.modal.submit': 'Set password',
  'pack.settings.error.minLength': 'Password must be at least 8 characters.',
  'pack.settings.error.noMatch': 'Passwords do not match.',
  'pack.settings.error.generic': 'Could not set password.',
  'pack.settings.toast.title': 'Password set',
  'pack.settings.toast.description': 'You can now log in with email + password.',
} as const;
