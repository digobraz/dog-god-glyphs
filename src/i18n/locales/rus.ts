...
export const rus: Partial<Dict> = {
  ...
  'login.eyebrow': 'Страж врат',
  'login.gate.cta': 'Создай его →',
  'login.gate.line': 'Через врата пройдёт только пёс с героглифом — и его человек. Нет его?',
  'login.forgot.prompt': 'Даже Hekthor однажды забыл, где закопал кость. Напиши e-mail, и я пришлю тебе новый ключ.',
  'login.forgot.title': 'Бывает',
  'login.password.forgotPassword': 'Забытый пароль',
  'login.password.magicLinkAlt': 'Пришли мне ключ на почту',
  ...
  'login.missing.title': 'Стой, кто идёт?',
  'login.missing.body': 'Собак я узнаю по нюху. Людей — по паролю.',
  ...
  'consent.body':
    'Единственные куки, которые мы советуем, — не для еды: они помогают нам улучшать сайт. Спасибо.',
  ...
  "sharecard.failed": "Не удалось сохранить карточку",
  ...
  "pack.globe.communityTitle": "Сообщество",
  ...
  "pack.invite.statLevel1": "Первая лапа",
  "pack.network.circle2": "Вторая лапа — приглашения твоей первой лапы",
  "pack.network.circle1": "Первая лапа — твои прямые приглашения",
  "pack.network.lineSplit": "{l1} в первой лапе · {l2} во второй",
  "pack.invite.statLevel1Sub": "напрямую",
  "pack.invite.statLevel2": "Вторая лапа",
  ...
  "pack.profile.countryFrequent": "Рядом",
  "pack.profile.countryAll": "Все страны",
  "pack.profile.countryOther": "Предпочитаю не говорить",
  "pack.profile.countryAria": "Страна",
  "pack.profile.pilgrimCta": "Туристический профиль",
};
