...
export const fra: Partial<Dict> = {
  ...
  "pack.invite.statLevel1": "Premier cercle",
  "pack.network.circle2": "Deuxième cercle — les invitations de votre premier cercle",
  "pack.network.circle1": "Premier cercle — vos invitations directes",
  "pack.network.lineSplit": "{l1} dans le premier cercle · {l2} dans le deuxième",
  "pack.invite.statLevel1Sub": "direct",
  "pack.invite.statLevel2": "Deuxième cercle",
