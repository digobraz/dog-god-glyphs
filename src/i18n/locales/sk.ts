...
export const sk: Partial<Dict> = {
  ...
  // ── /pack/trails — DOGYPT Trails F1 ──
  "pack.trails.title": "Trasy",
  "pack.trails.subtitle": "Kade chodia psíčkari",
  "pack.trails.addTip": "Pridaj tip",
  "pack.trails.close": "Zavrieť",
  "pack.trails.difficultyLabel": "Náročnosť",
  "pack.trails.distanceLabel": "Dĺžka",
  "pack.trails.ascentLabel": "Prevýšenie",
  "pack.trails.difficulty.easy": "Ľahká",
  "pack.trails.difficulty.moderate": "Stredná",
  "pack.trails.difficulty.hard": "Náročná",
  "pack.trails.difficulty.extreme": "Extrémna",
  "pack.trails.activity.water": "Voda",
  "pack.trails.activity.meadow": "Lúka",
  "pack.trails.activity.forest": "Les",
  "pack.trails.activity.ladders": "Rebríky",
  "pack.trails.activity.ford": "Brod",
  "pack.trails.placeType.water": "Voda",
  "pack.trails.placeType.cafe": "Podnik priateľský k psom",
  "pack.trails.placeType.vet": "Veterinár",
  "pack.trails.placeType.park": "Park",
  "pack.trails.placeType.shelter": "Útulok",
  "pack.trails.ratingsCount": "{avg} · {count} hodnotení",
  "pack.trails.noRatingsYet": "Zatiaľ bez hodnotenia",
  "pack.trails.rateThisTrail": "Ohodnoť túto trasu",
  "pack.trails.commentPlaceholder": "Pár slov o tejto trase…",
  "pack.trails.saving": "Ukladám…",
  "pack.trails.submitRating": "Odoslať hodnotenie",
  "pack.trails.ratingSaved": "Hodnotenie uložené — ďakujeme.",
  "pack.trails.ratingError": "Hodnotenie sa nepodarilo uložiť. Skús znova.",
  "pack.trails.addError": "Nepodarilo sa odoslať. Skús znova.",
  "pack.trails.addedPendingToast": "Odoslané — čaká na schválenie.",
  "pack.trails.filters.allRegions": "Všetky kraje",
  "pack.trails.filters.allDifficulties": "Všetky náročnosti",
  "pack.trails.addFlow.title": "Pridaj tip",
  "pack.trails.addFlow.modeTrail": "Trasa",
  "pack.trails.addFlow.modePlace": "Miesto",
  "pack.trails.addFlow.helpTrail": "Klikaním na mapu polož body pozdĺž trasy — minimálne dva.",
  "pack.trails.addFlow.helpPlace": "Klikni raz na mapu a označ miesto.",
  "pack.trails.addFlow.pointsCount": "{count} bodov",
  "pack.trails.addFlow.pointPlaced": "Bod položený",
  "pack.trails.addFlow.pointNotPlaced": "Zatiaľ žiadny bod — klikni na mapu",
  "pack.trails.addFlow.undo": "Vrátiť posledný",
  "pack.trails.addFlow.clear": "Vymazať",
  "pack.trails.addFlow.name": "Názov",
  "pack.trails.addFlow.description": "Popis",
  "pack.trails.addFlow.region": "Kraj",
  "pack.trails.addFlow.activities": "Aktivity",
  "pack.trails.addFlow.placeType": "Typ miesta",
  "pack.trails.addFlow.submit": "Odoslať na schválenie",
  "pack.trails.moderate.title": "Trasy — moderácia",
  "pack.trails.moderate.trailsHeading": "Čakajúce trasy",
  "pack.trails.moderate.placesHeading": "Čakajúce miesta",
  "pack.trails.moderate.empty": "Nič nečaká na schválenie.",
  "pack.trails.moderate.approve": "Schváliť",
  "pack.trails.moderate.reject": "Zamietnuť",
  "pack.trails.moderate.error": "Stav sa nepodarilo zmeniť. Skús znova.",
