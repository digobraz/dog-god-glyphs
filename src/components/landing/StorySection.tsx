        ...
        <div
          className="absolute inset-0"
            ...
            background: isMobile
              ...
              : 'linear-gradient(to right, rgba(0,0,0,0.85) 0%, rgba(0,0,0,0.4) 12%, transparent 30%, transparent 50%, rgba(0,0,0,0.15) 65%, rgba(0,0,0,0.4) 75%, rgba(0,0,0,0.7) 85%, rgba(0,0,0,0.9) 93%, rgb(0,0,0) 100%), linear-gradient(to top, rgba(0,0,0,0.7) 0%, rgba(0,0,0,0.4) 10%, rgba(0,0,0,0.15) 20%, transparent 40%)',
          }}
        />
