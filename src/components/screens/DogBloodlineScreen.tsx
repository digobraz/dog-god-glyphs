    ...
    <div className="dark-bg flex flex-col h-[100dvh] overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center px-4 overflow-y-auto">
        <div className="w-full max-w-xl flex flex-col items-center gap-3 py-2 my-auto">
          ...
          >
            <div className="<div className="rounded-2xl border-2 border-border papyrus-bg px-1.5 pt-8 pb-0"> className="rounded-2xl border-2 border-border papyrus-bg px-1.5 pt-8 pb-0">">
              <h2
