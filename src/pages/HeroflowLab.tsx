    ...
    steps: [
      {
        ...
        popup: 'photo',
        state: 'done',
        note: 'nad ľahkou scénou — nad ozajstnou stenou je riadok nižšie',
      },
      {
        name: '1b · Popup fotky nad stenou',
        path: '/',
        popup: 'photo',
        state: 'done',
      ...
      },
      {
        ...
        path: '/heroglyph/crop',
        state: 'wip',
        note: 'ZATIAĽ STARÁ OBRAZOVKA. Popup s auto-výrezom (g_auto, kruh → zaoblený štvorec, jeden posuvník + ťahanie) sa ešte stavia.',
      },
      {
        name: '3 · Meno psa',
        path: '/heroglyph/name',
      ...
      { name: '5 · E-mail', path: '/heroglyph/email', state: 'done' },
      { name: '6 · Prečo heroglyf', path: '/heroglyph/why', state: 'done' },
    ],
  },
  {
