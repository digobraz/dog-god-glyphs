...
// <<< VIPER_POINTS_GENERATED — needituj ručne, uprav stav a pusti generátor
  ...
  { id: 'kysuce-6', name: 'Kysuce a Javorníky', nameEN: 'Kysuce and the Javorníky', at: [49.2803, 19.3881] },
  { id: 'kysuce-7', name: 'Kysuce a Javorníky', nameEN: 'Kysuce and the Javorníky', at: [49.4214, 18.5858] },
  { id: 'kysuce-8', name: 'Kysuce a Javorníky', nameEN: 'Kysuce and the Javorníky', at: [49.3251, 19.1821] },
  ...
  { id: 'zapadne-2', name: 'Západné Tatry a Liptov', nameEN: 'Western Tatras and Liptov', at: [49.0109, 19.3359] },
  { id: 'zapadne-3', name: 'Západné Tatry a Liptov', nameEN: 'Western Tatras and Liptov', at: [49.0325, 19.5996] },
  { id: 'zapadne-4', name: 'Západné Tatry a Liptov', nameEN: 'Western Tatras and Liptov', at: [49.1283, 19.9415] },
  ...
  { id: 'zapadne-9', name: 'Západné Tatry a Liptov', nameEN: 'Western Tatras and Liptov', at: [49.2821, 19.5639] },
  ...
  { id: 'vysoke-1', name: 'Vysoké Tatry a Podtatranie', nameEN: 'High Tatras and Tatra foothills', at: [49.1688, 20.3296] },
  { id: 'vysoke-2', name: 'Vysoké Tatry a Podtatranie', nameEN: 'High Tatras and Tatra foothills', at: [49.1907, 19.9292] },
  { id: 'vysoke-3', name: 'Vysoké Tatry a Podtatranie', nameEN: 'High Tatras and Tatra foothills', at: [49.2127, 20.2925] },
  { id: 'vysoke-4', name: 'Vysoké Tatry a Podtatranie', nameEN: 'High Tatras and Tatra foothills', at: [49.1915, 20.3719] },
  { id: 'vysoke-5', name: 'Vysoké Tatry a Podtatranie', nameEN: 'High Tatras and Tatra foothills', at: [49.1314, 20.1077] },
  { id: 'vysoke-6', name: 'Vysoké Tatry a Podtatranie', nameEN: 'High Tatras and Tatra foothills', at: [49.3018, 20.1682] },
  { id: 'vysoke-7', name: 'Vysoké Tatry a Podtatranie', nameEN: 'High Tatras and Tatra foothills', at: [49.2273, 20.1276] },
  { id: 'vysoke-8', name: 'Vysoké Tatry a Podtatranie', nameEN: 'High Tatras and Tatra foothills', at: [49.2074, 20.0821] },
  { id: 'vysoke-9', name: 'Vysoké Tatry a Podtatranie', nameEN: 'High Tatras and Tatra foothills', at: [49.1494, 19.8935] },
  { id: 'vysoke-10', name: 'Vysoké Tatry a Podtatranie', nameEN: 'High Tatras and Tatra foothills', at: [49.1972, 20.3099] },
  { id: 'vysoke-11', name: 'Vysoké Tatry a Podtatranie', nameEN: 'High Tatras and Tatra foothills', at: [49.1781, 20.1736] },
  { id: 'vysoke-12', name: 'Vysoké Tatry a Podtatranie', nameEN: 'High Tatras and Tatra foothills', at: [49.2592, 20.1611] },
  { id: 'vysoke-13', name: 'Vysoké Tatry a Podtatranie', nameEN: 'High Tatras and Tatra foothills', at: [49.1314, 20.3522] },
  { id: 'velka-1', name: 'Veľká Fatra a Turiec', nameEN: 'Veľká Fatra and Turiec', at: [48.8286, 19.1766] },
  { id: 'velka-2', name: 'Veľká Fatra a Turiec', nameEN: 'Veľká Fatra and Turiec', at: [49.1314, 18.9432] },
  { id: 'velka-3', name: 'Veľká Fatra a Turiec', nameEN: 'Veľká Fatra and Turiec', at: [48.8828, 19.1245] },
  { id: 'velka-4', name: 'Veľká Fatra a Turiec', nameEN: 'Veľká Fatra and Turiec', at: [49.1655, 18.9349] },
  { id: 'nizke-1', name: 'Nízke Tatry a Horehronie', nameEN: 'Low Tatras and Horehronie', at: [49.1134, 19.7781] },
  { id: 'nizke-2', name: 'Nízke Tatry a Horehronie', nameEN: 'Low Tatras and Horehronie', at: [48.9874, 19.6463] },
  { id: 'nizke-3', name: 'Nízke Tatry a Horehronie', nameEN: 'Low Tatras and Horehronie', at: [48.8466, 19.6793] },
  { id: 'nizke-4', name: 'Nízke Tatry a Horehronie', nameEN: 'Low Tatras and Horehronie', at: [49.0757, 19.6902] },
  { id: 'nizke-5', name: 'Nízke Tatry a Horehronie', nameEN: 'Low Tatras and Horehronie', at: [48.8909, 19.4183] },
  { id: 'nizke-6', name: 'Nízke Tatry a Horehronie', nameEN: 'Low Tatras and Horehronie', at: [49.0973, 19.5502] },
  { id: 'nizke-7', name: 'Nízke Tatry a Horehronie', nameEN: 'Low Tatras and Horehronie', at: [49.3198, 19.5062] },
  ...
  { id: 'spis-2', name: 'Spiš — Poprad a Kežmarok', nameEN: 'Spiš — Poprad and Kežmarok', at: [49.2606, 20.3247] },
  ...
  { id: 'spis-5', name: 'Spiš — Poprad a Kežmarok', nameEN: 'Spiš — Poprad and Kežmarok', at: [48.9333, 20.5087] },
  { id: 'spis-6', name: 'Spiš — Poprad a Kežmarok', nameEN: 'Spiš — Poprad and Kežmarok', at: [49.0415, 20.2286] },
  { id: 'spis-7', name: 'Spiš — Poprad a Kežmarok', nameEN: 'Spiš — Poprad and Kežmarok', at: [49.0091, 20.5884] },
  { id: 'spis-8', name: 'Spiš — Poprad a Kežmarok', nameEN: 'Spiš — Poprad and Kežmarok', at: [49.2588, 20.5087] },
  { id: 'spis-9', name: 'Spiš — Poprad a Kežmarok', nameEN: 'Spiš — Poprad and Kežmarok', at: [49.3251, 20.5637] },
  ...
  { id: 'levoca-7', name: 'Levoča a Slovenský raj', nameEN: 'Levoča and Slovenský raj', at: [48.9423, 20.5911] },
  { id: 'saris-1', name: 'Šariš a Čergov', nameEN: 'Šariš and Čergov', at: [49.1116, 20.9619] },
  { id: 'saris-2', name: 'Šariš a Čergov', nameEN: 'Šariš and Čergov', at: [49.3448, 20.4895] },
  { id: 'saris-3', name: 'Šariš a Čergov', nameEN: 'Šariš and Čergov', at: [49.1296, 21.0306] },
  { id: 'saris-4', name: 'Šariš a Čergov', nameEN: 'Šariš and Čergov', at: [48.7852, 21.2283] },
  ...
  { id: 'saris-7', name: 'Šariš a Čergov', nameEN: 'Šariš and Čergov', at: [48.8521, 21.2119] },
  { id: 'bardejov-1', name: 'Bardejov a Ondavská vrchovina', nameEN: 'Bardejov and Ondava Highlands', at: [48.8846, 21.6211] },
  { id: 'bardejov-2', name: 'Bardejov a Ondavská vrchovina', nameEN: 'Bardejov and Ondava Highlands', at: [48.8665, 21.0168] },
  { id: 'bardejov-3', name: 'Bardejov a Ondavská vrchovina', nameEN: 'Bardejov and Ondava Highlands', at: [49.2104, 21.0059] },
  { id: 'bardejov-4', name: 'Bardejov a Ondavská vrchovina', nameEN: 'Bardejov and Ondava Highlands', at: [49.2929, 20.9152] },
  { id: 'bardejov-5', name: 'Bardejov a Ondavská vrchovina', nameEN: 'Bardejov and Ondava Highlands', at: [49.1602, 20.9097] },
  { id: 'bardejov-6', name: 'Bardejov a Ondavská vrchovina', nameEN: 'Bardejov and Ondava Highlands', at: [49.1817, 21.0635] },
  { id: 'kosicka-1', name: 'Košická kotlina a Slanské vrchy', nameEN: 'Košice Basin and Slanské Hills', at: [48.7924, 21.0938] },
  { id: 'kosicka-2', name: 'Košická kotlina a Slanské vrchy', nameEN: 'Košice Basin and Slanské Hills', at: [48.8195, 21.0251] },
  { id: 'kosicka-3', name: 'Košická kotlina a Slanské vrchy', nameEN: 'Košice Basin and Slanské Hills', at: [48.8503, 21.0855] },
  { id: 'rucny-mt459q57', name: 'Západné Tatry a Liptov', nameEN: 'Western Tatras and Liptov', at: [49.3949, 20.4868] },
  { id: 'rucny-mt459tn4', name: 'Západné Tatry a Liptov', nameEN: 'Western Tatras and Liptov', at: [49.4378, 20.4181] },
  { id: 'rucny-mt459w4x', name: 'Západné Tatry a Liptov', nameEN: 'Western Tatras and Liptov', at: [49.3377, 20.701] },
  ...
  { id: 'rucny-mt459zop', name: 'Západné Tatry a Liptov', nameEN: 'Western Tatras and Liptov', at: [49.3162, 20.7999] },
  { id: 'rucny-mt45a3gd', name: 'Západné Tatry a Liptov', nameEN: 'Western Tatras and Liptov', at: [49.4413, 20.4895] },
  { id: 'rucny-mt45a6s9', name: 'Západné Tatry a Liptov', nameEN: 'Western Tatras and Liptov', at: [49.2571, 20.9454] },
  { id: 'rucny-mt45a9s4', name: 'Západné Tatry a Liptov', nameEN: 'Western Tatras and Liptov', at: [49.3931, 20.7092] },
  { id: 'rucny-mt45al4g', name: 'Západné Tatry a Liptov', nameEN: 'Western Tatras and Liptov', at: [49.1224, 21.1267] },
