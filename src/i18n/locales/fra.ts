...
export const fra: Partial<Dict> = {
  ...
  "transparency.part.affiliate.note": "Pas de pub — des gens. Cela va droit dans les comptes des Dogyptians qui propagent la foi, payés en os : dépense-les plus tard dans DOGYPT ou offre-les aux chiens dans le besoin. Nous investissons dans la meute, jamais dans un marketing coûteux — la meute porte la parole bien plus loin.",
