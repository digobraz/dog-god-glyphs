...
export function WheelDatePicker({ day, month, year, minYear, maxYear, maxDate, onChange }: WheelDatePickerProps) {
  ...
  return (
    <div className="relative w-full overflow-hidden">
      ...
      />
      <div aria-hidden className="absolute inset-x-0 top-0 pointer-events-none z-10" style={{ height: ITEM_H, background: 'linear-gradient(180deg, hsl(var(--papyrus)) 0%, hsl(var(--papyrus)) 55%, hsl(var(--papyrus) / 0) 100%)' }} />
      <div aria-hidden className="absolute inset-x-0 bottom-0 pointer-events-none z-10" style={{ height: ITEM_H, background: 'linear-gradient(0deg, hsl(var(--papyrus)) 0%, hsl(var(--papyrus)) 55%, hsl(var(--papyrus) / 0) 100%)' }} />
